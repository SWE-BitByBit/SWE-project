...
\begin{description}
  ...
  \item[UAT] User Acceptance Testing: test eseguiti dall'utente finale per verifica dei requisiti.
  \item[CI/CD] Pipeline per integrazione continua, test automatici e rilascio continuo.
...
\hline
\rowcolor{white}
 & Redatto da & Visentin Giovanni & 2025/11/04 15:55 & Stesura iniziale del verbale \\
\hline
\rowcolor{gray!20}
