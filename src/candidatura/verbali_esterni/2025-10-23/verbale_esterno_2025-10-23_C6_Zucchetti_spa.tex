...
\subsection{Gestione utenti e \texorpdfstring{\term{Architettura}}{\term{Architettura}} applicativa}
È stato consigliato di implementare un sistema di \textbf{login} e un backend di gestione utenti e note. Tuttavia, la gestione dei dati dovrà avvenire in locale per un singolo \term{Utente}, mantenendo il focus sull’aspetto personale dell’applicazione.
