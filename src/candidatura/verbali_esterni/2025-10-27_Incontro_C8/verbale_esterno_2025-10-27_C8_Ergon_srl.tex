...
\subsection{Sistema di login e profilo \texorpdfstring{\term{Utente}}{\term{Utente}}}
...
\end{itemize}
Non è invece previsto che l’\term{Utente} possa modificare direttamente il database del catalogo, la cui gestione rimane competenza del backend.
