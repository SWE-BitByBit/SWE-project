...
\begin{center}
    {\LARGE \textbf{\term{Verbale} Riunione Numero 2}}
\end{center}
...
L’\term{Utente} potrà inserire gli ordini tramite:
\begin{itemize}
...
\subsection{Sistema di login e profilo \texorpdfstring{Utente}{\term{Utente}}}
È necessario implementare un sistema di autenticazione che consenta all’\term{Utente} di:
\begin{itemize}
...
L’interfaccia dovrà consentire all’\term{Utente} di:
\begin{itemize}
...
\end{itemize}
Non è invece previsto che l’\term{Utente} possa modificare direttamente il database del catalogo, la cui gestione rimane competenza del \term{Backend}.
