...
\begin{itemize}
    \item Stilare un \term{To-Do} meglio organizzato e più ampio
    \item Discussione sul way-of-working
    \item Aggiornamento \term{Repository} github
\end{itemize}
...
Dopodiché, sono state aggiunte \term{Issue} ed è stata creata una \term{Milestone} per la \term{Repository}.
...
\section{Decisioni}
\begin{itemize}
    \item Sono state decise delle \term{Issue} da aggiungere alla \term{Repository}, come la creazione del diario di bordo
...
\hline
\rowcolor{white}
1.0.0 & 2025-10-22 & Dennis Parolin & Stesura iniziale del \term{Verbale} & Riccardo Manisi \\
\hline
\end{tabular}
\end{center}
