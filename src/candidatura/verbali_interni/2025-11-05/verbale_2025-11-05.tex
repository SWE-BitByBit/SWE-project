...
\hline
\rowcolor{white}
Esempio Task 1 & Nome Cognome & 30/10/2025 & \href{https://github.com/<repo>/issues/1}{\textbf{issue}} \\
\hline
\rowcolor{gray!20}
Esempio Task 2 & Nome Cognome & 05/11/2025 & \href{https://github.com/<repo>/issues/2}{\textbf{issue}} \\
\hline
\rowcolor{white}
Esempio Task 3 & Nome Cognome & 10/11/2025 & \href{https://github.com/<repo>/issues/3}{\textbf{issue}} \\
\hline
\end{tabular}
\end{center}
...
\begin{document}
	...
	\begin{itemize}
		...
		\item Completare e aggiornare i documenti per l'invio della seconda candidatura.
	\end{itemize}
	
	% ---------- DISCUSSIONI ----------
	\section{Discussioni}
	Durante la riunione interna, i membri del gruppo hanno concordato di mandare la richiesta di candidatura al capitolato C4, cambiando da C8 in quanto gi\`a assegnato ad un altro gruppo; quindi hanno discusso sui documenti che andavano redatti e come si sarebbero potuti migliorare per renderli pi\`u ordinati e comprensibili, aggiornado anche la disposizione dei file e delle cartelle nella repository del progetto. 
	
	% ---------- DECISIONI ----------
	\section{Decisioni}
	Si \`e deciso di cambiare la richiesta di candidatura e redarne una nuova per il capitolato C4 da mandare il prima possibile, includendo la nuova pagina web di presentazione del gruppo.
	...
	\begin{center}
		...
		\begin{tabular}{|p{0.35\linewidth}|p{0.2\linewidth}|p{0.2\linewidth}|p{0.2\linewidth}|}
			...
			\hline
			\rowcolor{white}
			Redarre il documento di valutazione capitolati per la seconda candidatura & Gabriele Scaggiante & 2025-11-05 & \href{https://github.com/SWE-BitByBit/SWE-project/issues/54}{\textbf{issue}} \\
			\hline
			\rowcolor{gray!20}
			Redarre la domanda di seconda candidatura & Visentin Giovanni & 2025-11-05 & \href{https://github.com/SWE-BitByBit/SWE-project/issues/50}{\textbf{issue}} \\
			\hline
			\rowcolor{white}
			Sistemare i link ai documenti nella pagina web & Visentin Giovanni & 2025-11-05 & \href{https://github.com/SWE-BitByBit/SWE-project/issues/49}{\textbf{issue}} \\
			\hline
			\rowcolor{gray!20}
			Normalizzare i nome di file e cartelle & Riccardo Manisi & 2025-11-05 & \href{https://github.com/SWE-BitByBit/SWE-project/issues/53}{\textbf{issue}} \\
			\hline
		\end{tabular}
	\end{center}
	...
	\begin{center}
		...
		\begin{tabular}{|p{0.1\linewidth}|p{0.18\linewidth}|p{0.22\linewidth}|p{0.20\linewidth}|p{0.22\linewidth}|}
			...
			\hline
			\rowcolor{white}
			0.1.0 & 2025-11-05 & Marco Sanguin  & Stesura iniziale del verbale &  \\
			\hline
