...
\subsection*{RTB}
Sigla per \textbf{Requirements and Tecnology Baseline}. Rappresenta una baseline di progetto che ha come prodotti:
\begin{itemize}
    \item la lista dei requisiti funzionali e non funzionali da soddisfare, stati stabiliti con la proponente;
    \item il PoC, con cui vengono esposte le tecnologie, i framework, le librerie da adottare, dimostrandone adeguatezza e interoperabilità. 
\end{itemize}
...
Queste regole si basano su pratiche comuni e preesistenti in uso sia nel software enterprise che in quello open source.
