...
\rowcolor{white}
<<<<<<< HEAD
0.10.2 & 2026-01-13 & Riccardo Manisi & Eliminata sezione aggiunta tag su gestione configurazione & Gabriele Scaggiante\\
=======
...
Per sostenere il processi di sviluppo sono stati utilizzati i seguenti strumenti:
\begin{itemize}
    \item \textbf{Lucid chart}: piattaforma per la modellazione UML. Lo strumento consente la creazione di diagrammi UML (tra cui diagrammi dei casi d'uso, delle classi e di sequenza) direttamente in ambiente web, favorendo la collaborazione sincrona tra i membri del gruppo sullo stesso documento.
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item i \textbf{destinastari} del documento.
    \end{itemize}
\end{itemize}
...
Dove:
\begin{itemize}
    \item \texttt{<descrizione delle modifiche>}, comprende una breve descrizione delle modifiche applicate in quel branch, senza utilizzare spazi e le parole separate da \textbf{tattini (-)};
...
\hline
\rowcolor{gray!20}
\centering Lucid chart & Strumento per la creazione di diagrammi, utilizzato per la redazione dei diagrammi UML dei casi d’uso. Scelto per la possibilità di collaborazione in tempo reale, che ha consentito a più membri del gruppo di lavorare simultaneamente.\\
\hline
