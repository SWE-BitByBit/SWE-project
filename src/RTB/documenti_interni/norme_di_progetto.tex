...
\begin{itemize}
    ...
    \item \textbf{Flutter}: framework opensource per lo sviluppo di applicazioni iOS, Android, Web, Windows, MacOS e Linux. Utilizzato nell'ambito del progetto per lo sviluppo dell'interfaccia utente dell'applicazione mobile richiesta dall'applicazione.
\end{itemize}
