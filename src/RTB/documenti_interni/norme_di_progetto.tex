...
\paragraph{Verifica e revisione della pull request}
...
\paragraph{Strumenti per la verifica della documentazione}
...
\begin{enumerate}
    ...
    \item \textbf{Test di Accettazione}: Verifiche formali finali, condotte da utenti o stakeholder, per confermare che un software soddisfi i requisiti aziendali e funzionali prima del rilascio in produzione.
\end{enumerate}
