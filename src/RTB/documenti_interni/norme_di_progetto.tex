...
\begin{itemize}
    ...
    \item \texttt{<documento soggetto alle modifiche>}, sigla (che segue la nomenclatura in \hyperref[sigle]{Sezione~\ref*{sigle}}) per il documento il documento a cui avvengono apportate le modifiche.
\end{itemize}
