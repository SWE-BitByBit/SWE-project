...
La definizione puntuale degli strumenti tecnici per la Verifica del codice (es. Framework di unit testing, Linter specifici per linguaggio, strumenti di Analisi Statica e coverage) sarà effettuata e dettagliata durante lo svolgimento della \textbf{Product Baseline} (PB), in coerenza con le tecnologie che verranno consolidate in quella fase.
