...
\hline
\rowcolor{gray!20}
0.10.0 & 2026-01-06 & Dennis Parolin & Aggiunta sezioni "Processo di verifica", "Processo di validazione" e "Codifica".  & Riccardo Manisi \\
\hline
\rowcolor{white}
0.9.1 & 2026-01-06 & Ferdinando Fracasso & Aggiunta "Piano di qualifica" nella sezione Documentazione fornita  & Riccardo Manisi\\
\hline
\rowcolor{gray!20}
...
Nessuna issue può essere avviata senza che sia assegnata ad un membro del gruppo. L’assegnazione viene effettuata dal \textbf{responsabile\ap{G}}, che determina chi, nel gruppo, è incaricato dell’esecuzione di quella precisa attività. Questo passaggio garantisce che ogni modifica sia riconducibile a un autore e che la responsabilità operativa sia chiaramente definita.
...
\paragraph{Verifica} Il verificatore esamina sia la correttezza formale sia sostanziale del documento.
    ...
    \end{itemize}
Le modifiche richieste devono essere applicate dall’autore originario della pull request\ap{G}, che procede aggiornando il branch \texttt{develop} fino alla completa risoluzione.
...
\paragraph{Approvazione e pull request} Una volta ottenuta l’approvazione del verificatore, la \textbf{pull request\ap{G}} viene sottoposta alla visione del \textbf{responsabile\ap{G}}, che effettua un ultima revisione formale. Solo il \textbf{responsabile\ap{G}} è autorizzato a procedere con il merge della pull request nel branch \texttt{develop}.
...
Quando la \textbf{pull request\ap{G}} viene approvata del \textbf{verificatore\ap{G}}, il responsabile esegue la revisione. Si impegna ad eseguire il merge nel branch \texttt{develop}. A questo punto, la modifica entra ufficialmente in \textbf{baseline\ap{G}} e diventa parte del progetto.
...
\begin{itemize}
    ...
    \begin{itemize}
        \item uno a fine Sprint, comprendenteSprint Review \textbf{Sprint Retrospective\ap{G}} e \textbf{Sprint Planning\ap{G}}. In questa sede il \textbf{Responsabile} verifica lo stato delle attività concluse, analizza eventuali problemi riscontrati e pianifica il lavoro del successivo Sprint;
