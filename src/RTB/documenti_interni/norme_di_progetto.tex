...
\hline
\rowcolor{gray!20}
0.4.0 & 2025-12-11 & Ferdinando Fracasso & Aggiunta sezione "Processo di fornitura" & \\
\hline
\rowcolor{white}
...
A seguire sono riportati gli strumenti utilizzati dal gruppo BitByBit per il processo di fornitura:
\begin{itemize}
    \item \textbf{Discord:}
    \begin{itemize}
        \item Piattaforma di messaggistica utilizzata dai membri del gruppo per effettuare riunioni interne e per condividere file.
    \end{itemize}

    \item \textbf{Whatsapp:}
    \begin{itemize}
        \item App di messaggistica mobile utilizzata dai membri del gruppo per permettere comunicazione rapida.
    \end{itemize}

    \item \textbf{Github:}
    \begin{itemize}
        \item Piattaforma usata per il controllo del versionamento del progetto e per tracciare e gestire le issue.
    \end{itemize}

    \item \textbf{Google Chat:}
    \begin{itemize}
        \item Piattaforma di messaggistica online dove uno spazio è stato messo a disposizione dal proponente per comunicazione rapida e asincrona.
    \end{itemize}

    \item \textbf{Google Meet:}
    \begin{itemize}
        \item Piattaforma per videoconferenze, utilizzata per organizzare incontri con il proponente.
    \end{itemize}
\end{itemize}
