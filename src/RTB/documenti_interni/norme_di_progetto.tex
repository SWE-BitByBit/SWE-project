...
\subsubsection{Scopo}
Il processo primario di fornitura definisce le attività che devono essere intraprese dal fornitore. Il processo consta dell’analisi e pianificazione delle risorse necessarie per garantire l’efficienza e la conformità del progetto ai requisiti discussi con la proponente.
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Documento in cui il gruppo \textbf{BitByBit} ufficializza la propria candidatura al capitolato dell’azienda \textbf{Miriade S.r.l.}.
...
\begin{itemize}
    ...
    \item \textbf{Flutter}: framework utilizzato nell'ambito del progetto per lo sviluppo dell'interfaccia utente dell'applicazione mobile richiesta dall'applicazione.
\end{itemize}
...
\begin{itemize}
    \item \textbf{GitHub}: è lo strumento principale. L'interfaccia delle Pull Request permette ai verificatori di commentare righe specifiche del documento, richiedere modifiche e approvare il lavoro solo quando la checklist di verifica è soddisfatta.
