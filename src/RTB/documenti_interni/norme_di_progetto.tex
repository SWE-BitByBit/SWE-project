...
\hline
\rowcolor{gray!20}
0.9.0 & 2025-12-31 & Riccardo Manisi & Aggiunta sezione con metriche per QA & Ferdinando Fracasso \\
\hline
\rowcolor{white}
...
\begin{itemize}
    ...
    \item \textbf{Formula:} $PV=(\text{Budget at Completition})\cdot(\text{\% di lavoro pianificata nello sprint})$
...
\begin{itemize}
    ...
    \item \textbf{Formula:} $EAC=\frac{\text{Budget at Completition}-\text{EV}}{\text{CPI}}$
...
\begin{itemize}
    ...
    \item \textbf{Formula:} $CC=\frac{\text{\# linee di codice testate}}{\text{\# linee di codice totatali}}*100$
