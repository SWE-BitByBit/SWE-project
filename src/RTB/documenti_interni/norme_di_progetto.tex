...
\hline
\rowcolor{white}
0.2.1 & 2025-12-07 & Riccardo Manisi & Aggiunta attività di implementazione e istituzione di git e github per processo di infrastruttura & Giovanni Visentin\\
\hline
\rowcolor{gray!20}
...
Il processo di infrastruttura ha lo socpo di stabilire e mantenere l'infrastruttura necessaria per eseguire gli altri processi di ciclo di vita.\\L'infrastruttura, che sia hardware o software, comprende strumenti, standard e le strutture per lo sviluppo, il funzionamento e la manutenzione.
...
\hline
\rowcolor{white}
\centering Google Meet & Piattaforma sicnorona per videoconferenze utilizzata negli incontri con l’azienda proponente, in quanto standard scelto dal committente.\\
\hline
\rowcolor{gray!20}
\centering Google Chat & Piattaforma di messaggistica organizzata per stanze e conversazioni strutturate. Proposta dall'azienda proponente come canale ascincono per le comunicazioni.\\
\hline
\rowcolor{white}
...
\hline
\rowcolor{gray!20}
\centering Google Mail & Servizio di posta elettronica utilizzato come canale asincorno formale di comunicazione verso l’esterno. Scelto per la sua affidabilità e per l’integrazione con gli altri strumenti Google.\\
\hline
\rowcolor{white}
...
\hline
\rowcolor{gray!20}
\centering Google Sheets & Foglio di calcolo online utilizzato per i dati riguardanti i singoli Sprint e rappresentarli in appositivi grafici per una visualizzazione migliore. Scelto per la collaborazione sincrona e la facilità di aggiornamento in tempo reale.\\
\hline
\rowcolor{white}
...
La presente attività di \textbf{istituzione dell'infrastrruttura} ha lo scopo di documentare la configurazione dell'infrastruttura per facilitarne la manutenzione e la modifica da parte dei membri del gruppo BitByBit.
