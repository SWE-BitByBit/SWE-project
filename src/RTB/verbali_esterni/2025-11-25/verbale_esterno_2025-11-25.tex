...
\hline
\rowcolor{gray!20}
Definizione delle linee guida per l'Interfaccia Utente (UI) &  VE \ignoreglossary{RTB} 2.2 \\
\hline
\end{tabular}
\end{center}
...
\hline
\rowcolor{gray!20}
Scelta e finalizzazione del design dell'Interfaccia Utente (UI) per il PoC & VE \ignoreglossary{RTB} 2.2 & \href{https://github.com/SWE-BitByBit/SWE-docs/issues/86}{\textbf{\#86}} \\
\hline
\end{tabular}
\end{center}
