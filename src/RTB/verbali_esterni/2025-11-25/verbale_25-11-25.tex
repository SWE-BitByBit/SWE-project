...
\hline
\rowcolor{white}
Definizione delle funzionalità operative da implementare & VE \term{Rtb} 2.1 \\
\hline
\rowcolor{gray!20}
Definizione delle linee guida per l'Interfaccia \term{Utente} (UI) &  VE \term{Rtb} 2.2 \\
\hline
\end{tabular}
\end{center}
...
\hline
\rowcolor{white}
Analisi tecnica preliminare dei servizi AWS per l'individuazione delle risorse idonee all'implementazione delle funzionalità & VE \term{Rtb} 2.1 & \href{https://github.com/SWE-BitByBit/SWE-docs/issues/85}{\textbf{\#85}} \\
\hline
\rowcolor{gray!20}
Scelta e finalizzazione del design dell'Interfaccia \term{Utente} (UI) per il \term{Poc} & VE \term{Rtb} 2.2 & \href{https://github.com/SWE-BitByBit/SWE-docs/issues/86}{\textbf{\#86}} \\
\hline
\end{tabular}
\end{center}
