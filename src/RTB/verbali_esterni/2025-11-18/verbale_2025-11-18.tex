...
\begin{document}
	...
	\end{itemize}
	Lo scopo della presentuazione era ricevere un riscontro riguardo le funzionalit\`a proposte in relazione alle aspettative della \term{Proponente} e avere una stima dei tempi e di fattibilit\`a, considerando anche la loro numerosit\`a.
