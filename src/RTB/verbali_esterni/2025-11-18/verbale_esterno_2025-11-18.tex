...
\end{itemize}
Lo scopo della presentuazione era ricevere un riscontro riguardo le funzionalità proposte in relazione alle aspettative della Proponente e avere una stima dei tempi e di fattibilit\`a, considerando anche la loro numerosit\`a.
...
\hline
\rowcolor{gray!20}
Utilizzo di Google Chat come canale asincrono di comunicazione tra gruppo e Proponente &  VE \ignoreglossary{RTB} 1.2 \\
\hline
\end{tabular}
\end{center}
