...
\begin{document}
	...
	\begin{center}
		...
		\begin{tabular}{|p{0.73\textwidth}|c|}
			...
			\hline
			\rowcolor{white}
			Fissato incontro in presenza Marted\`i 25 novembre & VE \term{Rtb} 1.1 \\
			\hline
			\rowcolor{gray!20}
			Utilizzo di Google Chat come canale asincrono di comunicazione tra gruppo e \term{Proponente} &  VE \term{Rtb} 1.2 \\
			\hline
		\end{tabular}
	\end{center}
