...
\hline
\rowcolor{white}
Iniziare la stesura del documento interno norme di progetto per insierire il Processo secondario di documentazione. & VI \ignoreglossary{RTB} 1.1 \\
\hline
\rowcolor{gray!20}
Miglioramento della Repository a fronte dei commenti del Prof.Vardanega &  VI \ignoreglossary{RTB} 1.2 \\
\hline
\rowcolor{white}
Mandare la mail a Miriade per il primo incontro. Stabilito il periodo che Ci andrebbe bene per il primo incontro con la Proponente. & VI \ignoreglossary{RTB} 1.3\\
\hline
\rowcolor{gray!20}
Studio preliminare delle sezioni e dei contenuti che devono esserci presenti nel file Piano di progetto &  VI \ignoreglossary{RTB} 1.4\\
\hline
\rowcolor{white}
Miglioramento del Way of working seguendo i problemi riscontrati lavorando alla Repository. &  VI \ignoreglossary{RTB} 1.5\\
\hline
\end{tabular}
\end{center}
...
\hline
\rowcolor{gray!20}
Studio come redigere al meglio il Piano di progetto. & VI \ignoreglossary{RTB} 1.2 & \href{https://github.com/SWE-BitByBit/SWE-project/issues/74}{\textbf{74}} \\
\hline
\rowcolor{white}
Studio Way of working & VI \ignoreglossary{RTB} 1.5 & \href{https://github.com/SWE-BitByBit/SWE-project/issues/75}{\textbf{75}} \\
\hline
\rowcolor{gray!20}
setup della repo github per seguire il Way of working & VI \ignoreglossary{RTB} 1.5 & \href{https://github.com/SWE-BitByBit/SWE-project/issues/76}{\textbf{76}} \\
\hline
\end{tabular}
\end{center}
