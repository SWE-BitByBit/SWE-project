...
Il processo di fornitura monitora l'avanzamento del progetto rispetto alla pianificazione iniziale.
...
Il processo di documentazione è il principale garante dell'estendibilità del sistema.
\begin{table}[H]
\centering
\renewcommand{\arraystretch}{1.5}
\begin{tabularx}{\textwidth}{|c|X|c|c|}
