...
\textbf{MPD2} & Requisiti desiderabili soddisfatti & $\ge 30\%$ & $100\%$ \\ \hline
\textbf{MPD3} & Requisiti opzionali soddisfatti & $\ge 0\%$ & $\ge 70\%$ \\ \hline
\textbf{MPD4} & Defect Density (DD) & $\ge 0\%$ & $\ge 70\%$ \\ \hline
\textbf{MPD5} & Cyclomatic Complexity & $\ge 0\%$ & $\ge 70\%$ \\ \hline
\textbf{MPD6} & Lenght of code & $\ge 0\%$ & $\ge 70\%$ \\ \hline
\textbf{MPD7} & Depth of Conditional Nesting (DCN) & $\ge 0\%$ & $\ge 70\%$ \\ \hline
\end{tabularx}
...
\hline
\rowcolor{gray!30} \textbf{ID} & \textbf{Nome} & \textbf{Valore accettabile} & \textbf{Valore ottimo} \\ \hline
\textbf{MPD8} & Defeact Leakeage & $\ge 60\%$ & $\ge 80\%$ \\ \hline
\textbf{MPD9} & Defeact Removal Efficenty (DRE) & $\ge 60\%$ & $\ge 80\%$ \\ \hline
\textbf{MPD10} & Bug Rate per Test Case & $\le 10\%$ & $0\%$ \\ \hline
\end{tabularx}
