...
\newcommand{\VersioneAttuale}{0.3.3}
...
\hline
\rowcolor{gray!20}
0.3.3 & 2026-01-24 & Dennis Parolin & Aggiunta del graficco di distribuzione ore per task (\ref{fig:distribuzione_ore_rtb}) nella sezione di attività previste per la RTB e sistemate alcune date non presenti nel documento & Gabriele Scaggiante \\
\hline
\rowcolor{white}
