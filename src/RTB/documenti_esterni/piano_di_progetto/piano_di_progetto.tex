...
% =======================================================
\newcommand{\TitoloDocumento}{Piano di Progetto v0.1.0}
...
\hypersetup{
    colorlinks=true,
    linkcolor=blue,     % Colore link interni (es. indice)
    filecolor=blue,
...
% Definizione colonna 'Y' per tabularx (testo centrato auto-adattante)
\newcolumntype{Y}{>{\centering\arraybackslash}X}
% Definizione colonna 'Z' per tabularx (testo allineato a sx auto-adattante)
\newcolumntype{Z}{>{\raggedright\arraybackslash}X}
...
\begin{center}
    \begin{minipage}{0.25\textwidth}
        \centering
        % Assicurati che il file esista, altrimenti commenta la riga sotto
        \includegraphics[width=\linewidth]{logoUni.png}
    \end{minipage}
    \hfill
    \begin{minipage}{0.7\textwidth}
...
\hline
\rowcolor{white}
0.3.0 & 2025-12-5 & Dennis Parolin & Redazione dell'intera sezione \ref{sec:pianificazione_lungo_termine} & \\
\hline
\rowcolor{gray!20}
0.2.0 & 2025-12-4 & Dennis Parolin & Redazione delle sezioni \ref{sec:analisi_rischi} con relative sottosezioni \ref{sec:rischi_tecnologici}, \ref{sec:rischi_organizzativi} e \ref{sec:rischi_interpersonali} & \\
\hline
\rowcolor{white}
0.1.0 & 2025-12-3 & Dennis Parolin & Creazione del documento e redazione delle sezioni \ref{sec:scopo_documento}, \ref{sec:definizioni_acronimi_abbreviazioni}, \ref{sec:riferimenti} (con relative sottosezioni \ref{sec:riferimenti_normativi} e \ref{sec:riferimenti_informativi}). & \\
\hline
\end{tabularx}
\end{center}
...
\begin{itemize}
    ...
    \item \href{https://www.math.unipd.it/~tullio/IS-1/2025/Progetto/C4.pdf}{Norme di Progetto}\todo{Mettere link corretto alle norme di progetto}
\end{itemize}
