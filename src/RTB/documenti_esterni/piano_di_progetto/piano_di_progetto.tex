...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|L|Z|}
        ...
        \hline
        \rowcolor{tableLineEven}
        Mitigazione & Fissare gli incontri con anticipo di minimo una settimana e ci devono essere tutti i componeni del gruppo affinchè l'incontro abbia un effetto per l'avanzamento. \\
        \hline
        \rowcolor{tableLineOdd}
        Frequenza probabile & Media \\
        \hline
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|L|Z|}
        ...
        \hline
        \rowcolor{tableLineOdd}
        Descrizione & Comunicazione assenta per un periodo di tempo maggiore di una settimana da parte di un componente del gruppo con anche mancata presenza ad eventuali incontri interni. Senza il completamento delle attività assegnate.\\
        \hline
        \rowcolor{tableLineEven}
        Mitigazione & Nessuna. \\
        \hline
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|L|Z|}
        ...
        \hline
        \rowcolor{tableLineEven}
        Redazione casi d'uso per AdR & Implementazione della sezione del documento Analisi dei Requisiti relativa ai casi d'uso. \\
        \hline
        \rowcolor{tableLineEven}
