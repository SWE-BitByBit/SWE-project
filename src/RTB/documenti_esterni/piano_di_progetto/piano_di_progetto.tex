...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|L|Z|}
        ...
        \hline
        \rowcolor{tableLineOdd}
        Descrizione & Il team potrebbe incontrare difficoltà nell'apprendimento rapido dei framework e delle tecnologie richieste dal \term{Capitolato}, causando rallentamenti nello sviluppo. \\
        \hline
        \rowcolor{tableLineEven}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|L|Z|}
        ...
        \hline
        \rowcolor{tableLineEven}
        Mitigazione & Applicazione rigorosa di Unit Testing e Integration Testing. Obbligo di Code Review ("approvazione") prima di ogni \term{Merge} nel ramo principale. Adozione di pipeline di Continuous Integration (\term{Ci}). \\
        \hline
        \rowcolor{tableLineOdd}
        Frequenza probabile & Media \\
        \hline
...
\subsection{Attività previste per la Requirements and Technology \term{Baseline} (\term{Rtb})}
...
\subsection{Attività previste per la Product \term{Baseline} (\term{Pb})}
...
% ======================= \term{Rtb} =======================
\subsection{Requirements and Technology \term{Baseline} (\term{Rtb})}

\subsubsection{\term{Sprint} 1}\label{sec:sprint1_RTB}
...
\subsubsection{\term{Sprint} 2}\label{sec:sprint2_RTB}
...
\subsubsection{\term{Sprint} 3}\label{sec:sprint3_RTB}
...
\subsubsection{\term{Sprint} 4}\label{sec:sprint4_RTB}
...
\begin{itemize}
    ...
    \item \textbf{RT1}: Difficoltà iniziali nello studio delle tecnologie e dei framework necessari per la realizzazione del \textit{Proof of Concept} (\term{Poc}).
