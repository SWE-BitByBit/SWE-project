...
\newcommand{\VersioneAttuale}{0.4.4}
...
\rowcolor{white}
0.4.0 & 2026-01-12 & Ferdinando Fracasso & Redazione consultivo sprint nella sezione \ref{sec:sprint4_RTB}, redazione sezione \ref{sec:sprint5_RTB} e inizio sezione \ref{sec:sprint6_RTB} &  \\
\hline
\rowcolor{gray!20}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=1.2]
        ...
        \draw[thick,fill=pieAmm] (0,0) -- (85:1.5) arc (85:212:1.5) -- cycle;
        \draw (148:1.9) node {35\%};
        
        \draw[thick,fill=pieAnal] (0,0) -- (212:1.5) arc (212:297:1.5) -- cycle;
        \draw (254:1.8) node {24\%};
        
        \draw[thick,fill=pieVer] (0,0) -- (297:1.5) arc (297:360:1.5) -- cycle;
        \draw (328:1.9) node {17\%};
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|l|C|C|C|C|C|C|}
        ...
        \hline
        \rowcolor{tableLineOdd}
        D. Parolin & - & 2.5 \textcolor{red}{(-1.5)} & 5.5 \textcolor{red}{(+3,5)} & - & - & 2 \textcolor{red}{(-0,5)}\\
        \hline
        \rowcolor{tableLineEven}
...
\begin{figure}[H]
    \centering
    \begin{tikzpicture}[scale=1.2]
        \draw[thick,fill=pieResp] (0,0) -- (0:1.5) arc (0:57:1.5) -- cycle;
        \draw (28.5:2.1) node {15.8\%};
        
        \draw[thick,fill=pieAmm] (0,0) -- (57:1.5) arc (57:180:1.5) -- cycle;
        \draw (118.5:1.9) node {34.2\%};
        
        \draw[thick,fill=pieAnal] (0,0) -- (180:1.5) arc (180:275:1.5) -- cycle;
        \draw (227.5:1.9) node {26.3\%};

        \draw[thick,fill=pieDes] (0,0) -- (275:1.5) arc (275:313:1.5) -- cycle;
        \draw (294:1.8) node {10.5\%};
        
        \draw[thick,fill=pieVer] (0,0) -- (313:1.5) arc (313:360:1.5) -- cycle;
        \draw (336:2.1) node {13.2\%};
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|l|C|C|C|C|C|C|}
        ...
        \hline
        \rowcolor{tableLineOdd}
        G. Scaggiante & - & 0\textcolor{red}{(-3)} & 0\textcolor{red}{(-1)} & 0\textcolor{red}{(-2)} & - & 0\textcolor{red}{(-1)} \\
        \hline
        \rowcolor{tableLineEven}
        G. Visentin & 4 & - & 1 & 0\textcolor{red}{(-2)} & - & - \\
        \hline
    \end{tabularx}
...
\begin{figure}[H]
    \centering
    \begin{tikzpicture}[scale=1.2]
        \draw[thick,fill=pieResp] (0,0) -- (0:1.5) arc (0:141:1.5) -- cycle;
        \draw (70.5:1.8) node {39.3\%};
        
        \draw[thick,fill=pieAmm] (0,0) -- (141:1.5) arc (141:226:1.5) -- cycle;
        \draw (183.5:2.0) node {23.5\%};
        
        \draw[thick,fill=pieAnal] (0,0) -- (226:1.5) arc (226:311:1.5) -- cycle;
        \draw (268.5:1.8) node {23.5\%};
        
        \draw[thick,fill=pieVer] (0,0) -- (311:1.5) arc (311:360:1.5) -- cycle;
        \draw (335.5:2.0) node {13.7\%};
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|l|c|c|c|X|X|}
        ...
        \hline
        \rowcolor{tableLineOdd}
        Responsabile & 30\euro/h & 10 & 300\euro & 47 \textcolor{red}{(-10)} & 1.410\euro \textcolor{red}{(-300\euro)} \\
        \hline
        \rowcolor{tableLineEven}
        Amministratore & 20\euro/h & 6 & 120\euro & 57.5 \textcolor{red}{(-6)} & 1.150\euro \textcolor{red}{(-120\euro)} \\
        \hline
        \rowcolor{tableLineOdd}
        Analista & 25\euro/h & 6 & 150\euro & 23.5 \textcolor{red}{(-6)} & 587,50\euro \textcolor{red}{(-150\euro)} \\
        \hline
        \rowcolor{tableLineEven}
        Progettista & 25\euro/h & - & - & 102 & 2.550\euro \\
        \hline
        ...
        \hline
        \rowcolor{tableLineEven}
        Verificatore & 15\euro/h & 3.5 & 52,5\euro & 71.5 \textcolor{red}{(-3.5)} & 1.065\euro \textcolor{red}{(-52,50\euro)} \\
        \hline
        \rowcolor{tableHeader}
        \textbf{Totale} & - & \textbf{25.5} & \textbf{622,50\euro} & \textbf{404 \textcolor{red}{(-25.5)}} & \textbf{8.562,50\euro \textcolor{red}{(-622,50\euro)}} \\
        \hline
    \end{tabularx}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|l|C|C|C|C|C|C|}
        ...
        \hline
        \rowcolor{tableLineEven}
        R. Manisi & - & - & - & - & 0.5\textcolor{red}{(-1.5)} & - \\
        \hline
        \rowcolor{tableLineOdd}
        D. Parolin & - & 0.5\textcolor{red}{(-1.5)} & - & - & - & 0.5\textcolor{red}{(-0.5)} \\
        \hline
        \rowcolor{tableLineEven}
        M. Sanguin & - & - & 0\textcolor{red}{(-5)} & - & - & - \\
        \hline
        \rowcolor{tableLineOdd}
        G. Scaggiante & - & - & - & - & 0\textcolor{red}{(-2)} & 0\textcolor{red}{(-1)} \\
        \hline
        \rowcolor{tableLineEven}
        G. Visentin & - & - & 2 & - & - & 0\textcolor{red}{(-1)} \\
        \hline
    \end{tabularx}
...
\begin{figure}[H]
    \centering
    \begin{tikzpicture}[scale=1.2]
        \draw[thick,fill=pieResp] (0,0) -- (0:1.5) arc (0:166.32:1.5) -- cycle;
        \draw (83.16:1.8) node {46.2\%};
        
        \draw[thick,fill=pieAmm] (0,0) -- (166.32:1.5) arc (166.32:194.04:1.5) -- cycle;
        \draw (180.18:1.9) node {7.7\%};
        
        \draw[thick,fill=pieAnal] (0,0) -- (194.04:1.5) arc (194.04:304.56:1.5) -- cycle;
        \draw (249.3:1.8) node {30.7\%};

        \draw[thick,fill=pieProg] (0,0) -- (304.56:1.5) arc (304.56:332.28:1.5) -- cycle;
        \draw (318.42:1.9) node {7.7\%};
        
        \draw[thick,fill=pieVer] (0,0) -- (332.28:1.5) arc (332.28:360:1.5) -- cycle;
        \draw (346.14:1.9) node {7.7\%};
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|l|c|c|c|X|X|}
        ...
        \hline
        \rowcolor{tableLineOdd}
        Responsabile & 30\euro/h & 3 & 90\euro & 44 \textcolor{red}{(-3)} & 1.320\euro \textcolor{red}{(-90\euro)} \\
        \hline
        \rowcolor{tableLineEven}
        Amministratore & 20\euro/h & 0.5 & 10\euro & 57 \textcolor{red}{(-0.5)} & 1.130\euro \textcolor{red}{(-10\euro)} \\
        \hline
        \rowcolor{tableLineOdd}
        Analista & 25\euro/h & 2 & 50\euro & 25.5 \textcolor{red}{(-2)} & 537,50\euro \textcolor{red}{(-50\euro)} \\
        \hline
        \rowcolor{tableLineEven}
        Progettista & 25\euro/h & - & - & 102 & 2.550\euro \\
        \hline
        \rowcolor{tableLineOdd}
        Programmatore & 15\euro/h & 0.5 & 7.5\euro & 119.5 \textcolor{red}{(-0.5)} & 1.792,50\euro \textcolor{red}{(-7,50\euro)} \\
        \hline
        \rowcolor{tableLineEven}
        Verificatore & 15\euro/h & 0.5 & 7.5\euro & 71 \textcolor{red}{(-0.5)} & 1.072,5\euro \textcolor{red}{(-7,50\euro)} \\
        \hline
        \rowcolor{tableHeader}
        \textbf{Totale} & - & \textbf{6.5} & \textbf{165\euro} & \textbf{397.5 \textcolor{red}{(-6.5)}} & \textbf{8.397,50\euro \textcolor{red}{(-165\euro)}} \\
        \hline
    \end{tabularx}
...
Le attività pianificate e svolte includono:
\begin{itemize}
    \item \textit{Analisi:} Continuare studio delle funzionalità per il \textit{Proof of Concept}.
    \item \textit{Incontri:} Riunione interna per organizzare le attività dello sprint 6; Chiarimenti su \textit{diagrammi UML} riguardanti la funzionalità di walkthrough.
    \item \textit{Programmazione:} Inizio dello sviluppo front-end \textit{Proof of Concept} e implementazione delle seguenti funzionalità:
    \begin{itemize}
    ...
    \end{itemize}
    \item \textit{Documentazione:} Aggiornamento del \textit{Piano di Progetto} fino allo sprint corrente; Completamento della sezione \textit{Casi d'Uso} dell'\textit{Analisi dei Requisiti}; Verifica completa delle \textit{Norme di Progetto}.
    \item \textit{Gestione:} Completamento dell'integrazione del glossario; Creazione Github Action per deploy lambda su AWS.
\end{itemize}
