...
\begin{figure}[H]
    \centering
    \begin{tikzpicture}[scale=1.2]
        \draw[thick,fill=pieResp] (0,0) -- (0:1.5) arc (0:64:1.5) -- cycle;
        \draw (32:2) node {17.7\%};
        
        \draw[thick,fill=pieAmm] (0,0) -- (64:1.5) arc (64:202:1.5) -- cycle;
        \draw (133:1.95) node {38.2\%};
        
        \draw[thick,fill=pieAnal] (0,0) -- (202:1.5) arc (202:308:1.5) -- cycle;
        \draw (255:1.9) node {29.4\%};
