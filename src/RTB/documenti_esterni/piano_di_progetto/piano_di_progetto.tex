...
\newcommand{\VersioneAttuale}{0.5.0}
...
\rowcolor{gray!20}
0.5.0 & 2026-02-23 & Dennis Parolin & Completata la sezione "Sprint 6" (\ref{sec:sprint6_RTB}) e fatta la prima metà della sezione "Sprint 7" (\ref{sec:sprint7_RTB}). Corretti errori di compilazione ed & Giovanni Visentin \\
\hline
\rowcolor{white}
...
\begin{table}[H]
\centering
\begin{tabularx}{\textwidth}{|c|c|>{\raggedright\arraybackslash\hsize=0.65\hsize}X|>{\raggedright\arraybackslash\hsize=1.35\hsize}X|c|}
\hline
\rowcolor{gray!60}
\textbf{Versione} & \textbf{Data} & \textbf{Autore} & \textbf{Descrizione} & \textbf{Verificatore} \\
\hline
...
\begin{itemize}
    \item \textbf{Analisi:} Continuo dello studio delle funzionalità per il \textit{Proof of Concept}.
...
\begin{itemize}
    ...
    \item \textbf{RT2}: Ritardi dovuti a permessi AWS od orchestrativi parziali e frammentati resi disponibili durante lo sviluppo iterativo dalla proponente.
...
\begin{figure}[H]
    \centering
    \begin{tikzpicture}[scale=1.2]
        \draw[thick,fill=pieResp] (0,0) -- (0:1.5) arc (0:42.8:1.5) -- cycle;
        \draw (21.4:1.95) node {11.9\%};
        
        \draw[thick,fill=pieAmm] (0,0) -- (42.8:1.5) arc (42.8:123.4:1.5) -- cycle;
        \draw (83.1:1.8) node {22.4\%};
        
        \draw[thick,fill=pieAnal] (0,0) -- (123.4:1.5) arc (123.4:155.8:1.5) -- cycle;
        \draw (139.6:1.95) node {9.0\%};
        
        \draw[thick,fill=pieVer] (0,0) -- (155.8:1.5) arc (155.8:220.2:1.5) -- cycle;
        \draw (188:1.95) node {17.9\%};

        \draw[thick,fill=pieProg] (0,0) -- (220.2:1.5) arc (220.2:360:1.5) -- cycle;
        \draw (290.1:1.8) node {38.8\%};
