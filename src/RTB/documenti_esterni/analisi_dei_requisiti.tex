...
% =======================================================
\newcommand{\TitoloDocumento}{Analisi dei Requisiti v0.2.0}
...
\hline
\rowcolor{gray!20}
0.2.0 & 2025-12-1 & Dennis Parolin & Redazione della sezione \ref{sec:funzioni_prodotto}. Modifica delle sezioni \ref{sec:prospettiva_prodotto} e \ref{sec:caratteristiche_utente} sulla base delle funzionalità concordate con la proponente. Spostato il registro delle modifiche (sezione \ref{sec:registro_modifiche}) a prima dell'indice. & \\
\hline
\rowcolor{white}
0.1.0 & 2025-11-23 & Dennis Parolin & Creazione documento e redazione delle sezioni \ref{sec:scopo_documento}, \ref{sec:prospettiva_prodotto}, \ref{sec:caratteristiche_utente}, \ref{sec:definizioni_acronimi_abbreviazioni}, \ref{sec:riferimenti}, \ref{sec:riferimenti_normativi} e \ref{sec:riferimenti_informativi} & \\
\hline
\end{tabularx}
\end{center}
...
\clearpage
\section{Casi d'uso}
% Qui verranno inseriti i diagrammi UML e le descrizioni
In questa sezione sono descritti gli attori e i casi d'uso individuati per il sistema.

% Placeholder per le future sottosezioni
\subsection{Elenco degli attori}
[Inserire descrizione attori]

\subsection{Elenco dei casi d'uso}
[Inserire diagrammi e descrizioni]
...
\clearpage
\section{Requisiti}
In questa sezione vengono elencati i requisiti del sistema, classificati in funzionali, di qualità e di vincolo.
...
\renewcommand{\arraystretch}{1.4} 
\arrayrulecolor{black}
% Tabella Requisiti: c=Codice (stretto), X=Descrizione (largo), c=Fonte (stretto)
...
\hline
\rowcolor{white}
RF1 & L'utente deve poter effettuare il login tramite credenziali istituzionali. & UC1 \\
\hline
\rowcolor{gray!20}
RF2 & [Inserire requisito funzionale...] & Interno \\
\hline
\rowcolor{white}
RF3 & [Inserire requisito funzionale...] & Capitolato \\
\hline
\end{tabularx}
\end{center}
...
\hline
\rowcolor{white}
RQ1 & Il sistema deve essere corredato di manuale utente. & Capitolato \\
\hline
\rowcolor{gray!20}
RQ2 & [Inserire requisito di qualità...] & Interno \\
\hline
\end{tabularx}
\end{center}
...
\hline
\rowcolor{white}
RV1 & Il software deve essere sviluppato utilizzando il linguaggio [X]. & Capitolato \\
\hline
\rowcolor{gray!20}
RV2 & [Inserire requisito di vincolo...] & Interno \\
\hline
\end{tabularx}
\end{center}

\subsection{Tracciamento dei Casi d'Uso e Riepilogo}
% Questa sezione serve solitamente per le matrici di tracciamento (Fonte -> Requisito, Requisito -> Test)
\paragraph{Matrice Fonte - Requisiti}
[Inserire tabella di tracciamento]

\paragraph{Riepilogo}
[Inserire statistiche o grafici riepilogativi dei requisiti]
