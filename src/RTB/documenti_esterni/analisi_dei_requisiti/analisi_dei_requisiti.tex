...
\subsubsection{UC-59 - Visualizzazione lista community} \label{sec:UC-59}
\begin{figure}[H]
    \centering
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Il sistema visualizza a schermo la lista delle community $\rightarrow$ \ref{subsec:UC-59.1}
    \end{itemize}
    \item \textbf{Scenario secondario:} 
    \begin{itemize}
    ...
    \item \textbf{Inclusioni:} 
    \begin{itemize}
        \item \hyperref[subsec:UC-59.1]{UC-59.1}
    \end{itemize}
    \item \textbf{Estensioni:} 
    \begin{itemize}
        \item \hyperref[subsec:UC-5]{UC-5}
...
\subsubsection{UC-59.1 - Visualizzazione singola community nella lista} \label{subsec:UC-59.1}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Generico
    \item \textbf{Pre-condizioni:} 
    \begin{itemize}
    ...
    \begin{itemize}
        \item L'attore visualizza una singola community all'interno della lista
        \item L'attore visualizza il nome della community  $\rightarrow$ \ref{subsec:UC-59.1.1}
        \item L'attore visualizza il link della community  $\rightarrow$ \ref{subsec:UC-59.1.2}
    \end{itemize}
    \item \textbf{Inclusioni:} 
    \begin{itemize}
        \item \hyperref[subsec:UC-59.1.1]{UC-59.1.1}
        \item \hyperref[subsec:UC-59.1.2]{UC-59.1.2}
    \end{itemize}
    \item \textbf{Trigger:} L'attore vuole vedere la lista delle community esistenti
\end{itemize}

\subsubsection{UC-59.1.1 - Visualizzazione nome singola community nella lista} \label{subsec:UC-59.1.1}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Generico
    \item \textbf{Pre-condizioni:} 
    \begin{itemize}
...
\subsubsection{UC-59.1.2 - Visualizzazione link singola community nella lista} \label{subsec:UC-59.1.2}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Generico
    \item \textbf{Pre-condizioni:} 
    \begin{itemize}
...
\subsubsection{UC-60 - Apertura link della community} \label{sec:UC-60}
\begin{figure}[H]
    \centering
...
\subsubsection{UC-63 - Visualizzazione lista contatti d'emergenza} \label{sec:UC-63}
\begin{tcolorbox}[colback=gray!10,colframe=gray!50,title=Nota]
{\small Il caso d'uso \hyperref[sec:UC-63]{UC-63} include il caso d'uso \hyperref[subsec:UC-63.1]{UC-63.1}, si mostrano anche ulteriori casi d'uso correlati (\hyperref[subsec:UC-63.1.1]{UC-63.1.1} e \hyperref[subsec:UC-63.1.2]{UC-63.1.2}), la cui descrizione dettagliata è riportata nelle sezioni successive del documento.}
\end{tcolorbox}
\begin{figure}[H]
    \centering
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Il sistema visualizza le voci della lista $\rightarrow$ \ref{subsec:UC-63.1}
    \end{itemize}
    \item \textbf{Inclusioni:} 
    \begin{itemize}
        \item \hyperref[subsec:UC-63.1]{UC-63.1}
    \end{itemize}
    \item \textbf{Trigger:} L'attore vuole consultare i numeri rapidi di emergenza
\end{itemize}

\subsubsection{UC-63.1 - Visualizzazione singolo contatto ente d'emergenza} \label{subsec:UC-63.1}
\begin{itemize}
    ...
    \item \textbf{Scenario principale:} 
    \begin{itemize}
        \item Il sistema visualizza il nome identificativo del contatto $\rightarrow$ \ref{subsec:UC-63.1.1}
        \item Il sistema visualizza il numero telefonico associato al contatto $\rightarrow$ \ref{subsec:UC-63.1.2}
    \end{itemize}
    \item \textbf{Inclusioni:}
    \begin{itemize}
        \item \hyperref[subsec:UC-63.1.1]{UC-63.1.1}
        \item \hyperref[subsec:UC-63.1.2]{UC-63.1.2}
    \end{itemize}
\end{itemize}

\subsubsection{UC-63.1.1 - Visualizzazione nome contatti d'emergenza} \label{subsec:UC-63.1.1}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Generico
    \item \textbf{Pre-condizioni:} 
    \begin{itemize}
...
\subsubsection{UC-63.1.2 - Visualizzazione numero contatti d'emergenza} \label{subsec:UC-63.1.2}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Generico
    \item \textbf{Pre-condizioni:} 
    \begin{itemize}
...
\subsubsection{UC-64 - Composizione automatica numero contatto} \label{sec:UC-64}
\begin{figure}[H]
    \centering
