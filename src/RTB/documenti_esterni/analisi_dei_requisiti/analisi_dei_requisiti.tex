...
\begin{itemize}
    ...
    \item \textbf{Scenario secondario:} 
    \begin{itemize}
        \item L'attore interrompe il \term{Processo} di analisi del messaggio dell'LLM \ref{sec:UC-49}
        \item Il messaggio non riesce ad essere inviato causa mancanza di connessione \ref{sec:UC-58}
        \item L'LLM riscontra un problema durante la lettura del messaggio \ref{sec:UC-50}
    \end{itemize}
    \item \textbf{Estensioni:}
    \begin{itemize}
        \item \hyperref[sec:UC-49]{UC-49}
        \item \hyperref[sec:UC-58]{UC-58}
...
\subsubsection{UC-58 - Mancanza di connessione} \label{sec:UC-58}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Generico
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
...
\subsubsection{UC-50 - Errore di lettura del messaggio} \label{sec:UC-50}
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item L'\term{Utente} può chiedere di riprovare a leggere il messaggio \ref{sec:UC-49}
...
\begin{itemize}
    ...
    \item \textbf{Scenario secondario:} 
    \begin{itemize}
        \item Errore nello switch di contesto \ref{sec:UC-53}
    \end{itemize}
    \item \textbf{Estensioni:} 
    \begin{itemize}
