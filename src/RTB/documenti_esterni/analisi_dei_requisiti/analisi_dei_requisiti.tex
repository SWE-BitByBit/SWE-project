...
\subsubsection{UC-D1 - Impostazione password per diario criptato} \label{subsec:UC-D1}
\begin{figure}[H]
    \centering
    % INCLUDERE IMMAGINE CORRETTA
...
\begin{itemize}
    ...
    \begin{itemize}
        \item La password non è conforme ai criteri di sicurezza minimi imposti dal sistema. La password non viene memorizzata e viene mostrato un messaggio di errore. $\rightarrow$ \ref{subsec:UC-D2}
    \end{itemize}
    \item \textbf{Estensioni:}
    \begin{itemize}
        \item \hyperref[subsec:UC-D2]{UC-D2}
    \end{itemize}
    \item \textbf{Trigger:} L'attore interagisce con il form di inserimento della password per il diario criptato
\end{itemize}

\subsubsection{UC-D2 - Password non conforme ai criteri} \label{subsec:UC-D2}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Generico
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
...
\subsubsection{UC-D3 - Impostazione password per diario fittizio} \label{subsec:UC-D3}
\begin{figure}[H]
    \centering
    % INCLUDERE IMMAGINE CORRETTA
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Il sistema è attivo
        \item L'attore ha impostato la password per il diario criptato
    ...
    \item \textbf{Scenari secondari:} 
    \begin{itemize}
        \item La password del diario fittizio combacia con quella già impostata del diario criptato. $\rightarrow$ \ref{subsec:UC-D4}
        \item La password non è conforme ai criteri di sicurezza minimi imposti dal sistema. La password non viene memorizzata e viene mostrato un messaggio di errore. $\rightarrow$ \ref{subsec:UC-D2}
    \end{itemize}
    \item \textbf{Estensioni:}
    \begin{itemize}
        \item \hyperref[subsec:UC-D4]{UC-D4}
        \item \hyperref[subsec:UC-D2]{UC-D2}
    \end{itemize}
    \item \textbf{Trigger:} L'attore interagisce con il form di inserimento della password per il diario fittizio
\end{itemize}

\subsubsection{UC-D4 - Password uguale alla password del diario criptato} \label{subsec:UC-D4}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} autenticato al diario
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
...
\subsubsection{UC-D5 - Inserimento password accesso diario} \label{subsec:UC-D5}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} autenticato al diario
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
    ...
    \item \textbf{Post-condizioni:} 
    \begin{itemize}
        \item L'\term{Utente} ha accesso al diario corrispondente alla password inserita
    \end{itemize}
    \item \textbf{Scenario principale:} 
    \begin{itemize}
    ...
    \item \textbf{Scenari secondari:} 
    \begin{itemize}
        \item L'attore inserisce la password errata. Il sistema notifica l'errore e impedisce l'accesso al diario. $\rightarrow$ \ref{subsec:UC-D6}
        \item L'attore ha inserito la password errata più volte di quanto consentito dal sistema. Il sistema nega l'accesso e disabilita l'inserimento della password per un periodo di tempo predefinito. $\rightarrow$ \ref{subsec:UC-D7}
    \end{itemize}
    \item \textbf{Estensioni:}
    \begin{itemize}
        \item \hyperref[subsec:UC-D6]{UC-D6}
        \item \hyperref[subsec:UC-D7]{UC-D7}
    \end{itemize}
        \item \textbf{Trigger:} L'attore tenta di accedere al diario
        \item \textbf{Caso d'uso generale di:}
    \begin{itemize}
        \item \hyperref[subsec:UC-D8]{UC-D8}
        \item \hyperref[subsec:UC-D9]{UC-D9}
    \end{itemize}

\end{itemize}

\subsubsection{UC-D6 - Inserimento password errata} \label{subsec:UC-D6}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} autenticato al diario
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
    ...
    \item \textbf{Scenario principale:} 
    \begin{itemize}
        \item Il sistema confronta la password inserita con quelle memorizzate
...
\subsubsection{UC-D7 - Password errata troppe volte} \label{subsec:UC-D7}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} autenticato al diario
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
...
\subsubsection{UC-D8 - Inserimento password accesso diario criptato} \label{subsec:UC-D8}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} autenticato al diario
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
        \item Il sistema è attivo
        \item L'attore si trova nella schermata di accesso al diario
        \item Il diario criptato è stato precedentemente configurato con una password
    \end{itemize}
    \item \textbf{Post-condizioni:} 
    \begin{itemize}
        \item L'\term{Utente} ha accesso al diario criptato
    \end{itemize}
    \item \textbf{Scenario principale:} 
    \begin{itemize}
        \item L'attore inserisce la password nel campo dedicato
...
\subsubsection{UC-D9 - Inserimento password accesso diario fittizio} \label{subsec:UC-D9}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} autenticato al diario
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
    ...
    \item \textbf{Post-condizioni:} 
    \begin{itemize}
        \item L'\term{Utente} ha accesso al diario fittizio
    \end{itemize}
    \item \textbf{Scenario principale:} 
    \begin{itemize}
        \item L'attore inserisce la password nel campo dedicato
...
\subsubsection{UC-D10 - Visualizzazione diario criptato} \label{subsec:UC-D10}
\begin{figure}[H]
    \centering
    % INCLUDERE IMMAGINE CORRETTA
    \caption{Diagramma del caso d'uso UC-D10}
    \label{fig:UC-D10}
\end{figure}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} autenticato al diario
    ...
    \begin{itemize}
        ...
        \item Il sistema carica e visualizza la lista delle note presenti $\rightarrow$ \ref{subsec:UC-D11}
    \end{itemize}
    \item \textbf{Inclusioni:}
    \begin{itemize}
        \item \hyperref[subsec:UC-D11]{UC-D11}
    \end{itemize}
    \item \textbf{Trigger:} L'attore accede al diario criptato
\end{itemize}

\subsubsection{UC-D11 - Visualizzazione lista note nel diario criptato} \label{subsec:UC-D11}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} autenticato al diario
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Il sistema organizza le anteprime delle note secondo un ordine prestabilito
        \item Il sistema visualizza, in una lista, le anteprime di ogni singola nota $\rightarrow$ \ref{subsec:UC-D12}
    \end{itemize}
    \item \textbf{Inclusioni:}
    \begin{itemize}
        \item \hyperref[subsec:UC-D12]{UC-D12}
    \end{itemize}
    \item \textbf{Trigger:} L'attore accede al diario criptato
\end{itemize}

\subsubsection{UC-D12 - Visualizzazione anteprima singola nota della lista nel diario criptato} \label{subsec:UC-D12}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} autenticato al diario
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Il sistema visualizza l'anteprima della nota nella lista
    \end{itemize}
    \item \textbf{Trigger:} L'attore accede al diario criptato
\end{itemize}

\subsubsection{UC-D13 - Visualizzazione diario fittizio} \label{subsec:UC-D13}
\begin{figure}[H]
    \centering
    % INCLUDERE IMMAGINE CORRETTA
    \caption{Diagramma del caso d'uso UC-D13}
    \label{fig:UC-D13}
\end{figure}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} autenticato al diario
    ...
    \begin{itemize}
        ...
        \item Il sistema carica e visualizza la lista delle note presenti $\rightarrow$ \ref{subsec:UC-D14}
    \end{itemize}
    \item \textbf{Inclusioni:}
    \begin{itemize}
        \item \hyperref[subsec:UC-D14]{UC-D14}
    \end{itemize}
    \item \textbf{Trigger:} L'attore accede al diario fittizio
\end{itemize}

\subsubsection{UC-D14 - Visualizzazione lista note nel diario fittizio} \label{subsec:UC-D14}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} autenticato al diario
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Il sistema organizza le anteprime delle note secondo un ordine prestabilito
        \item Il sistema visualizza, in una lista, le anteprime di ogni singola nota $\rightarrow$ \ref{subsec:UC-D15}
    \end{itemize}
    \item \textbf{Inclusioni:}
    \begin{itemize}
        \item \hyperref[subsec:UC-D15]{UC-D15}
    \end{itemize}
    \item \textbf{Trigger:} L'attore accede al diario fittizio
\end{itemize}

\subsubsection{UC-D15 - Visualizzazione anteprima singola nota della lista nel diario fittizio} \label{subsec:UC-D15}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} autenticato al diario
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
