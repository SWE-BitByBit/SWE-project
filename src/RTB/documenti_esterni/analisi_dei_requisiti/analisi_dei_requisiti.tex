...
\hline
\rowcolor{gray!20}
RV-OB-6 & Le comunicazioni telematiche tra l'applicazione mobile (frontend) ed i microservizi di backend devono avvenire in modo sicuro tramite Amazon API Gateway & \href{https://www.math.unipd.it/~tullio/IS-1/2025/Progetto/C4.pdf}{Capitolato} \newline Sez. 3.4 \\
\hline
\rowcolor{white}
