...
\rowcolor{white}
 & 2026-03-17 & Dennis Parolin & Riscrittura dei casi d'uso da \hyperref[sec:UC-4]{UC-4} a \hyperref[subsec:UC-14]{UC-14}. Il caso d'uso \hyperref[sec:UC-5]{UC-5} è stato aggiunto come nuovo caso d'uso. Rifatta tutta la sezione "Requisiti di vincolo" (\ref{subsection:requisiti_vincolo}) e "Requisiti di qualità" (\ref{subsection:requisiti_qualita}). & Riccardo Manisi \\
\hline
\rowcolor{gray!20}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item L'attore guarda singolarmente i contatti fidati (la preview delle informazioni del contatto) nella lista ma non cliccla su nessuna voce $\rightarrow$ \hyperref[subsec:UC-6.1]{UC-6.1}
    \end{itemize}
    \item \textbf{Scenario secondario:} 
    \begin{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Il sistema è attivo
        \item L'attore sta visualizzando la lista dei contatti fidati $\rightarrow$ \hyperref[sec:UC-4]{UC-4}
    \end{itemize}
    \item \textbf{Post-condizioni:}
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item L'attore visualizza la preview del nome del contatto fidato $\rightarrow$ \hyperref[subsec:UC-4.1.1]{UC-4.1.1}
    \end{itemize}
    \item \textbf{Inclusioni:}
    \begin{itemize}
        \item \hyperref[subsec:UC-4.1.1]{UC-4.1.1}
    \end{itemize}
    \item \textbf{Trigger:} L'attore un singolo contatto fidato dalla lista
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Il sistema è attivo
        \item L'attore sta visualizzando la lista dei contatti fidati $\rightarrow$ \hyperref[sec:UC-4]{UC-4}
        \item L'attore visualizza un singolo contatto dalla lista $\rightarrow$ \hyperref[subsec:UC-4.1]{UC-4.1}
    \end{itemize}
    \item \textbf{Post-condizioni:}
    \begin{itemize}
        \item L'attore visualizza la preview del nome del contatto fidato
    \end{itemize}
    \item \textbf{Scenario principale:} 
    \begin{itemize}
        \item L'attore visualizza dalla lista, la preview del nome del singolo contatto fidato
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Il sistema è attivo
        \item L'attore ha selezionato una sezione da dover caricare tramite database
    \end{itemize}
    \item \textbf{Post-condizioni:} 
    \begin{itemize}
    ...
    \begin{itemize}
        \item Si verifica un errore
        \item Il sistema rivela il fallimento della richiesta a causa dell'errore
        \item Il sistema mostra un messaggio di errore all'utente
    \end{itemize}
    \item \textbf{Trigger:} Si verifica un errore durante il caricamento dei dati
\end{itemize}
...
\subsubsection{UC-9 - Numero di telefono già presente} \label{subsec:UC-9}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Autenticato
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
...
\subsubsection{UC-10 - Email già presente} \label{subsec:UC-10}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Autenticato
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Scenario secondario:}
    \begin{itemize}
        \item L'attore rifiuta la conferma dell'eliminazione del contatto fidato $\rightarrow$ \hyperref[subsec:UC-14]{UC-14}
    \end{itemize}
    \item \textbf{Estensioni:} 
    \begin{itemize}
