...
\hline
\rowcolor{gray!20}
RF-OB-2 & L'\term{Utente} vede attivarsi automaticamente la funzionalità di Dead Man Switch a seguito del login. & \hyperref[subsec:UC-1]{UC-1}, \hyperref[sec:UC-15]{UC-15} \\
\hline
\rowcolor{white}
...
\hline
\rowcolor{white}
RF-OB-13 & L'\term{Utente} deve poter visualizzare un messaggio di errore esplicativo nel caso in cui le informazioni di numero di telefono e email siano già presenti nel sistema. & \hyperref[subsec:UC-9]{UC-9}, \hyperref[subsec:UC-10]{UC-10} \\
\hline
\rowcolor{white}
RF-OB-13 & L'\term{Utente} deve poter reinserire le informazioni di numero di telefono e email dopo la visualizzazione del messaggio di errore esplicativo & \hyperref[subsec:UC-8]{UC-8}, \hyperref[subsec:UC-9]{UC-9}, \hyperref[subsec:UC-10]{UC-10}, \hyperref[subsec:UC-11]{UC-11} \\
\hline
\rowcolor{gray!20}
...
\hline
\rowcolor{gray!20}
RF-OB-18 & L'\term{Utente} deve poter confermare, con un'apposita voce, l'eliminazione di un contatto fidato quando il sistema richiede la conferma. & \hyperref[subsec:UC-13.1]{UC-13.1} \\
\hline
\rowcolor{gray!20}
...
\hline
\rowcolor{gray!20}
RF-OB-32 & L'\term{Utente} deve poter reinserire la password del diario criptato dopo la visualizzazione del messaggio di errore esplicativo & \hyperref[subsec:UC-22]{UC-22} \\
\hline
\rowcolor{white}
...
\hline
\rowcolor{white}
RF-OB-28 & L'\term{Utente} deve poter reinserire la password del diario fittizio dopo la visualizzazione del messaggio di errore esplicativo & \hyperref[subsec:UC-22]{UC-22}, \hyperref[subsec:UC-24]{UC-24} \\
\hline
\rowcolor{gray!20}
RF-OB-28 & L'\term{Utente} deve poter inserire la password per accedere al diario desiderato & \hyperref[subsec:UC-25]{UC-25} \\
\hline
\rowcolor{white}
RF-OB-28 & L'\term{Utente} deve poter inserire la password per accedere al diario criptato & \hyperref[subsec:UC-25.1]{UC-25.1} \\
\hline
\rowcolor{gray!20}
RF-OB-28 & L'\term{Utente} deve poter inserire la password per accedere al diario fittizio & \hyperref[subsec:UC-25.2]{UC-25.2} \\
\hline
\rowcolor{white}
...
\hline
\rowcolor{gray!20}
RF-OB-35 & L'\term{Utente} deve poter reinserire la password di accesso al diario dopo la visualizzazione del messaggio di errore esplicativo & \hyperref[subsec:UC-27]{UC-27} \\
\hline
\rowcolor{white}
