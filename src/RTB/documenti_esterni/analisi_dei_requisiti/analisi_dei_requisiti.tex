...
\begin{itemize}
    ...
    \item \textbf{Post-condizioni:}
    \begin{itemize}
        \item Il sistema ha inviato il messaggio di SOS ai contatti fidati dell'utente.
    \end{itemize}
    \item \textbf{Scenario principale:} 
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item L'utente non ha inserito nessun contatto fidato nella rete dei contatti fidati. $\rightarrow$ \hyperref[sec:UC-46]{UC-46}
    \end{itemize}
    \item \textbf{Estensioni:}
    \begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Scenario secondario:} 
    \begin{itemize}
        \item Si verifica un errore nel caricamento del contenuto della chat $\rightarrow$ \hyperref[sec:UC-5]{UC-5}
    \end{itemize}
    \item \textbf{Inclusioni:} 
    \begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Scenario secondario:} 
    \begin{itemize}
         \item Si verifica un errore nel caricamento dei dati dal database $\rightarrow$ \hyperref[sec:UC-5]{UC-5}
    \end{itemize}
    \item \textbf{Estensioni:}
    \begin{itemize}
     \item \hyperref[sec:UC-5]{UC-5}
