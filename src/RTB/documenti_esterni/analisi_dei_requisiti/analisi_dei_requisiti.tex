...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item L'attore guarda singolarmente i contatti fidati (e la preview delle informazioni del contatto) nella lista, ma non clicca su nessuna voce $\rightarrow$ \hyperref[subsec:UC-6.1]{UC-6.1}
    \end{itemize}
    \item \textbf{Scenario secondario:} 
    \begin{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item L'attore visualizza la anteprima del nome del contatto fidato $\rightarrow$ \hyperref[subsec:UC-4.1.1]{UC-4.1.1}
    \end{itemize}
    \item \textbf{Inclusioni:}
    \begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Post-condizioni:}
    \begin{itemize}
        \item L'attore visualizza la anteprima del nome del contatto fidato
    \end{itemize}
    \item \textbf{Scenario principale:} 
    \begin{itemize}
        \item L'attore visualizza la anteprima del nome del singolo contatto fidato dalla lista
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Post-condizioni:}
    \begin{itemize}
        \item Il sistema riceve il rifiuto da parte dell'attore all'eliminazione del contatto fidato dalla propria rete dei contatti fidati
    \end{itemize}
    \item \textbf{Scenario principale:} 
    \begin{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Il sistema \ignoreglossary{verifica} che la password corrisponda a quella del diario fittizio
...
\begin{itemize}
    ...
    \begin{itemize}
        \item L'attore seleziona l'opzione per accedere al diario
        \item L'attore procede con l'inserimento della password di accesso $\rightarrow$ \ref{subsec:UC-24}
        \item Il sistema \ignoreglossary{verifica} che la password corrisponda a quella del diario criptato
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Si \ignoreglossary{verifica} un errore tecnico (assenza di rete, errore server, timeout) durante il recupero dei dati
    \end{itemize}
    \item \textbf{Post-condizioni:} 
    \begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Post-condizioni:}
    \begin{itemize}
        \item Il sistema riceve il rifiuto da parte dell'attore per rimuovere la chat
...
\begin{itemize}
    ...
    \item \textbf{Scenario secondario:} 
    \begin{itemize}
         \item Si \ignoreglossary{verifica} un errore durante il recupero del file (es. file corrotto o offline) $\rightarrow$ \ref{subsec:UC-53.1}
    \end{itemize}
    \item \textbf{Estensioni:}
     \begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Scenario secondario:} 
    \begin{itemize}
         \item Si \ignoreglossary{verifica} un errore nell'apertura dell'applicazione esterna $\rightarrow$ \ref{subsec:UC-56}
    \end{itemize}
    \item \textbf{Estensioni:}
     \begin{itemize}
