...
\hline
\rowcolor{white}
1.3.1 & 2026-03-18 & Ferdinando Fracasso & Modificati UC-28, UC-29 e UC-32 (ora da \hyperref[subsec:UC-30]{UC-30} a \hyperref[subsec:UC-36]{UC-36} più sottocasi) & Dennis Parolin \\
\hline
\rowcolor{gray!20}
1.2.1 & 2026-03-18 & Gabriele Scaggiante & Riscrittura dei casi d'uso da \hyperref[subsec:UC-19]{UC-19} a \hyperref[subsec:UC-25]{UC-25}. Inserimento nuovi casi UC-26, UC-27, UC-28, UC-33, UC-34, UC-35. & Riccardo Manisi \\
\hline
\rowcolor{white}
1.1.1 & 2026-03-17 & Dennis Parolin & Riscrittura dei casi d'uso da \hyperref[subsec:UC-4]{UC-4} a \hyperref[subsec:UC-14]{UC-14}. Il caso d'uso \hyperref[sec:UC-5]{UC-5} è stato aggiunto come nuovo caso d'uso. Rifatta tutta la sezione "Requisiti di vincolo" (\ref{subsection:requisiti_vincolo}) e "Requisiti di qualità" (\ref{subsection:requisiti_qualita}). & Riccardo Manisi \\
\hline
\rowcolor{gray!20}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Trigger:} L'attore disattivare la funzionalità del Dead Man's Switch
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Il sistema è attivo.
        \item L'\term{Utente} ha cliccato la voce per l'invio del messaggio SOS.
    \end{itemize}
    \item \textbf{Post-condizioni:}
    \begin{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Trigger:} L’\term{Utente} ha selezionato la voce per il cambio del contesto.
\end{itemize}
