...
\hline
\rowcolor{gray!20}
RF-OB-2 & L'\term{Utente} vede attivarsi automaticamente la funzionalità di Dead Man's Switch a seguito del login. & \hyperref[subsec:UC-1]{UC-1}, \hyperref[sec:UC-15]{UC-15} \\
\hline
\rowcolor{white}
