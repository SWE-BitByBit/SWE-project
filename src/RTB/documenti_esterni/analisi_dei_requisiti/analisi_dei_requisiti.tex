...
\begin{itemize}
    ...
    \begin{itemize}
        \item La password non è conforme ai criteri di sicurezza minimi imposti dal sistema. La password non viene memorizzata e viene mostrato un messaggio di errore. $\rightarrow$ \hyperref[subsec:UC-20]{UC-20}
    \end{itemize}
    \item \textbf{Estensioni:}
    \begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Scenari secondari:} 
    \begin{itemize}
        \item La password del diario fittizio combacia con quella già impostata del diario criptato. $\rightarrow$ \hyperref[subsec:UC-22]{UC-22}
        \item La password non è conforme ai criteri di sicurezza minimi imposti dal sistema. La password non viene memorizzata e viene mostrato un messaggio di errore. $\rightarrow$ \hyperref[subsec:UC-20]{UC-20}
    \end{itemize}
    \item \textbf{Estensioni:}
    \begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Scenari secondari:} 
    \begin{itemize}
        \item L'attore inserisce la password errata. Il sistema notifica l'errore e impedisce l'accesso al diario. $\rightarrow$ \hyperref[subsec:UC-25]{UC-25}
        \item L'attore ha inserito la password errata più volte di quanto consentito dal sistema. Il sistema nega l'accesso e disabilita l'inserimento della password per un periodo di tempo predefinito. $\rightarrow$ \hyperref[subsec:UC-24]{UC-24}
    \end{itemize}
    \item \textbf{Estensioni:}
    \begin{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Il sistema carica e visualizza la lista delle note presenti $\rightarrow$ \hyperref[subsec:UC-27]{UC-27}
    \end{itemize}
    \item \textbf{Inclusioni:}
    \begin{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Il sistema visualizza, in una lista, le anteprime di ogni singola nota $\rightarrow$ \hyperref[subsec:UC-28]{UC-28}
    \end{itemize}
    \item \textbf{Scenario secondario:} 
    \begin{itemize}
        \item Il sistema non è in grado di soddisfare la richiesta dell'\term{Utente}. $\rightarrow$ \hyperref[subsec:UC-5]{UC-5}
    \end{itemize}
    \item \textbf{Inclusioni:}
    \begin{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Il sistema carica e visualizza la lista delle note presenti $\rightarrow$ \hyperref[subsec:UC-34]{UC-34}
    \end{itemize}
    \item \textbf{Inclusioni:}
    \begin{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Il sistema visualizza, in una lista, le anteprime di ogni singola nota $\rightarrow$ \hyperref[subsec:UC-35]{UC-35}
    \end{itemize}
    \item \textbf{Scenario secondario:} 
    \begin{itemize}
        \item Il sistema non è in grado di soddisfare la richiesta dell'\term{Utente}. $\rightarrow$ \hyperref[subsec:UC-5]{UC-5}
