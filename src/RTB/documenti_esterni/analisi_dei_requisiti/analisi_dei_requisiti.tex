...
\subsubsection{UC-30 - Creazione nota} \label{subsec:UC-30}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{use_case/UC-30-diario.png}
    \caption{Diagramma del caso d'uso UC-30}
    \label{fig:UC-28}
\end{figure}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Autenticato al diario
    ...
    \item \textbf{Post-condizioni:} 
    \begin{itemize}
        \item Il sistema memorizza la nuova nota nel diario criptato.
    \end{itemize}
    \item \textbf{Scenario principale:} 
    \begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Trigger:} L'utente vuole creare una nuova nota nel diario criptato
\end{itemize}

\subsubsection{UC-30.1 - Inserimento testo in nota diario criptato} \label{subsec:UC-30.1}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{use_case/UC-30_32-diario.png}
    \caption{Diagramma dei casi d'uso UC-30.1, UC-30.2, UC-30.2.1 e UC-30.2.2}
    \label{fig:UC-30.1, UC-30.2, UC-30.2.1, UC-30.2.2}
\end{figure}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Autenticato al diario
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
        \item Il sistema è attivo
        \item L'attore si trova all'interno del diario criptato
        \item L'attore si trova all'interno di una nota del diario criptato
    \end{itemize}
    \item \textbf{Post-condizioni:}
    \begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Trigger:} L'utente vuole aggiungere del testo ad una nota nel diario criptato
\end{itemize}

\subsubsection{UC-30.2 - Inserimento media in nota diario criptato} \label{subsec:UC-30.2}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Autenticato al diario
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
    ...
    \begin{itemize}
        \item \ref{subsec:UC-30.2.1}
        \item \ref{subsec:UC-30.2.2}
    \end{itemize}
    \item \textbf{Trigger:} L'utente vuole aggiungere del contenuto multimediale ad una nota nel diario criptato
\end{itemize}

\subsubsection{UC-30.2.1 - Inserimento immagine in nota diario criptato} \label{subsec:UC-30.2.1}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Autenticato al diario
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
        ...
        \item L'attore si trova all'interno del diario criptato
        \item L'attore si trova all'interno di una nota del diario criptato
        \item L'attore sta inserendo un media in una nota del diario criptato
    \end{itemize}
    \item \textbf{Post-condizioni:}
    \begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Trigger:} L'utente vuole aggiungere un'immagine ad una nota nel diario criptato
\end{itemize}

\subsubsection{UC-30.2.2 - Inserimento audio in nota diario criptato} \label{subsec:UC-30.2.2}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Autenticato al diario
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Trigger:} L'utente vuole aggiungere del contenuto audio ad una nota nel diario criptato
\end{itemize}

\subsubsection{UC-31 - Eliminazione nota} \label{subsec:UC-31}
\begin{figure}[H]
    \centering
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item L'attore ha selezionato una nota nel diario criptato
    \end{itemize}
    \item \textbf{Post-condizioni:} 
    \begin{itemize}
        \item La nota selezionata è stata rimossa dal diario criptato
        \item La nota non è più visibile nella lista delle note del diario criptato
    \end{itemize}
    \item \textbf{Scenario principale:} 
    \begin{itemize}
        \item L'attore seleziona una nota dalla lista delle note del diario criptato
    ...
    \end{itemize}
    \item \textbf{Trigger:} L'attore seleziona l'opzione di eliminazione nota nel diario criptato
\end{itemize}

\subsubsection{UC-31.1 - Modifica testo in nota diario criptato} \label{subsec:UC-31.1}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{use_case/UC-31_32-diario.png}
    \caption{Diagramma dei casi d'uso UC-31.1, UC-31.2, UC-31.2.1 e UC-31.2.2}
    \label{fig:UC-31.1, UC-31.2, UC-31.2.1, UC-31.2.2}
\end{figure}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Autenticato al diario
    \item \textbf{Pre-condizioni:}
...
\subsubsection{UC-31.2 - Inserimento media in nota diario criptato} \label{subsec:UC-31.2}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Autenticato al diario
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
        ...
        \item L'attore si trova all'interno del diario criptato
        \item L'attore si trova all'interno di una nota del diario criptato
        \item La nota visualizzata presenta almeno un contenuto multimendiale
    \end{itemize}
    \item \textbf{Post-condizioni:}
    \begin{itemize}
    ...
    \item \textbf{Specializzazioni}
    \begin{itemize}
        \item \ref{subsec:UC-31.2.1}
        \item \ref{subsec:UC-31.2.2}
    \end{itemize}
    \item \textbf{Trigger:} L'utente vuole rimuovere del contenuto multimediale da una nota nel diario criptato
\end{itemize}

\subsubsection{UC-31.2.1 - Inserimento immagine in nota diario criptato} \label{subsec:UC-31.2.1}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Autenticato al diario
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
        ...
        \item L'attore si trova all'interno del diario criptato
        \item L'attore si trova all'interno di una nota del diario criptato
        \item La nota visualizzata presenta almeno un'immagine
        \item L'attore sta rimuovendo del contenuto multimediale dalla nota visualizzata
    \end{itemize}
    \item \textbf{Post-condizioni:}
    \begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Trigger:} L'utente vuole rimuovere un'immagine da una nota nel diario criptato
\end{itemize}

\subsubsection{UC-31.2.2 - Inserimento audio in nota diario criptato} \label{subsec:UC-31.2.2}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Autenticato al diario
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
        ...
        \item L'attore si trova all'interno del diario criptato
        \item L'attore si trova all'interno di una nota del diario criptato
        \item La nota visualizzata presenta almeno una traccia audio
    \end{itemize}
    \item \textbf{Post-condizioni:}
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item L'attore seleziona la voce apposita per la rimozione dell'immagine
    \end{itemize}
    \item \textbf{Trigger:} L'utente vuole rimuovere una traccia audio da una nota nel diario criptato
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Post-condizioni:} 
    \begin{itemize}
        \item Il sistema visualizza il contenuto della nota del diario criptato selezionata
    \end{itemize}
    \item \textbf{Scenario principale:} 
    \begin{itemize}
        \item L'attore seleziona una nota dalla lista
        \item Il sistema recupera il contenuto completo della nota
        \item Il sistema visualizza a schermo il contenuto testuale della nota $\rightarrow$ \ref{subsec:UC-32.1}
        \item Il sistema visualizza a schermo il contenuto multimediale della nota $\rightarrow$ \ref{subsec:UC-32.2}
        \item L'attore può visualizzare e interagire con il contenuto della nota
    \end{itemize}
    \item \textbf{Inclusioni:}
    \begin{itemize}
        \item \ref{subsec:UC-32.1}
        \item \ref{subsec:UC-32.2}
    \end{itemize}
    \item \textbf{Trigger:} L'attore seleziona una nota dalla lista delle note del diario criptato
\end{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Trigger:} L'attore sta cercando di visualizzare una nota selezionata
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Specializzazioni:}
    \begin{itemize}
        \item \ref{subsec:UC-32.2.1}
        \item \ref{subsec:UC-32.2.1}
    \end{itemize}
    \item \textbf{Trigger:} L'attore sta cercando di visualizzare una nota selezionata
\end{itemize}

\subsubsection{UC-32.2.1 - Visualizzazione immagini nota diario criptato} \label{subsec:UC-32.2.1}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Autenticato al diario
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
...
\subsubsection{UC-32.2.2 - Visualizzazione audio nota diario criptato} \label{subsec:UC-32.2.2}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Autenticato al diario
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
