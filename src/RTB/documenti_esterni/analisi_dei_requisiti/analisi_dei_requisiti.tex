...
\begin{itemize}
    ...
    \begin{itemize}
        \item Il sistema è attivo
        \item La funzionalità Dead Man's Switch è abilitata UC-57
...
\subsubsection{UC-18.1 - Visualizzazione titolo mail di avviso} \label{subsec:UC-18.1}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Autenticato
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
...
\subsubsection{UC-18.2 - Visualizzazione corpo della mail di avviso} \label{subsec:UC-18.2}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Autenticato
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
