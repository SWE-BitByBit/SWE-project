...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item L'attore guarda singolarmente i contatti fidati (la preview delle informazioni del contatto) nella lista, ma non clicca su nessuna voce $\rightarrow$ \hyperref[subsec:UC-6.1]{UC-6.1}
    \end{itemize}
    \item \textbf{Scenario secondario:} 
    \begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Scenario principale:} 
    \begin{itemize}
        \item L'attore visualizza la preview del nome del singolo contatto fidato dalla lista
    \end{itemize}
\end{itemize}
