...
\hline
\rowcolor{gray!20}
RV-OB-8 & La logica di business all'interno delle funzioni serverless AWS Lambda deve essere implementata tramite il linguaggio di programmazione Python & Decisione interna \newline \href{https://swe-bitbybit.github.io/SWE-docs/docs/RTB/documenti_interni/norme_di_progetto.pdf}{Norme di Progetto} \\
\hline
\rowcolor{white}
