...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{use_case/UC-54-detective.png}
    \caption{Diagramma dei casi d'uso UC-54}
    \label{fig:UC-54}
\end{figure}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Generico
    ...
    \begin{itemize}
        ...
        \item L'attore visualizza la schermata della chat vuota $\rightarrow$ \ref{subsec:UC-56}
    \end{itemize}
    \item \textbf{Inclusioni:} 
    \begin{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item L'attore conferma l'intenzione di eliminare la chat $\rightarrow$ \ref{subsec:UC-55.1}
