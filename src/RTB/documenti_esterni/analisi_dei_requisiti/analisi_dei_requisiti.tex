...
\begin{itemize}
    ...
    \item \textbf{Scenario principale:} 
    \begin{itemize}
        \item Il sistema rileva che il messaggio inviato non è stato letto correttamente dal chatbot
        \item Il sistema notifica l'attore dell'errore
        \item L'attore può mandare un nuovo messaggio \ref{sec:UC-48}
    \end{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Trigger:} L’attore ha selezionato la voce per il cambio del contesto.
\end{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Trigger:} L'attore richiede il cambio di contesto ma si \ignoreglossary{verifica} un errore tecnico
...
\begin{itemize}
    ...
    \item \textbf{Scenario secondario:} 
    \begin{itemize}
        \item Errore nel caricamento del contenuto della chat $\rightarrow$ \ref{sec:UC-5}
    \end{itemize}
    \item \textbf{Inclusioni:} 
    \begin{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Il sistema visualizza i messaggi dell'attore $\rightarrow$ \ref{subsec:UC-56.1.1}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Il sistema mostra il titolo della chat nella lista $\rightarrow$ \ref{subsec:UC-57.1.1}
    \end{itemize}
    \item \textbf{Inclusioni:}
    \begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Scenario secondario:} 
    \begin{itemize}
        \item Il sistema rileva un errore nel caricamento dei dati $\rightarrow$ \ref{sec:UC-5}
    \end{itemize}
    \item \textbf{Inclusioni:} 
    \begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Scenario secondario:} 
    \begin{itemize}
         \item Errore nel caricamento dei dati $\rightarrow$ \ref{sec:UC-5}
    \end{itemize}
    \item \textbf{Estensioni:}
    \begin{itemize}
     \item \hyperref[sec:UC-5]{UC-5}
...
\begin{itemize}
    ...
    \item \textbf{Scenario secondario:} 
    \begin{itemize}
         \item Si \ignoreglossary{Verifica} un errore durante il recupero dei dati $\rightarrow$ \ref{sec:UC-5}
    \end{itemize}
    \item \textbf{Estensioni:}
     \begin{itemize}
         \item \hyperref[sec:UC-5]{UC-5}
...
\begin{itemize}
    ...
    \item \textbf{Scenario secondario:} 
    \begin{itemize}
         \item Si \ignoreglossary{Verifica} un errore nell'apertura dell'applicazione esterna $\rightarrow$ \ref{subsec:UC-69}
    \end{itemize}
    \item \textbf{Estensioni:}
     \begin{itemize}
