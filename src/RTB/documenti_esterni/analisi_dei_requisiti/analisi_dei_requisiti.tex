...
\hline
\rowcolor{white}
1.0.2 & 2026-03-17 & Ferdinando Fracasso & Modificati UC-28, UC-29 e UC-32 (ora UC-30, UC-31 e UC-32 più sottocasi) & Riccardo Manisi \\
\hline
\rowcolor{gray!20}
1.0.1 & 2026-03-17 & Riccardo Manisi & Modificati caso d'uso UC-17 e aggiunti sottocasi UC-17.1, UC-17.2  &  Gabriele Scagginate\\
\hline
\rowcolor{white}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Trigger:} L'\term{Utente} vuole creare una nuova nota nel diario criptato
\end{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Trigger:} L'\term{Utente} vuole aggiungere del testo ad una nota nel diario criptato
\end{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Trigger:} L'\term{Utente} vuole aggiungere del contenuto multimediale ad una nota nel diario criptato
\end{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Trigger:} L'\term{Utente} vuole aggiungere un'immagine ad una nota nel diario criptato
\end{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Trigger:} L'\term{Utente} vuole aggiungere del contenuto audio ad una nota nel diario criptato
\end{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Trigger:} L'\term{Utente} vuole rimuovere del contenuto multimediale da una nota nel diario criptato
\end{itemize}

\subsubsection{UC-36.1 - Inserimento immagine in nota diario criptato} \label{subsec:UC-36.1}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Autenticato al diario
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Trigger:} L'\term{Utente} vuole rimuovere un'immagine da una nota nel diario criptato
\end{itemize}

\subsubsection{UC-36.2 - Inserimento audio in nota diario criptato} \label{subsec:UC-36.2}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Autenticato al diario
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item L'attore seleziona la voce apposita per la rimozione dell'immagine
    \end{itemize}
    \item \textbf{Trigger:} L'\term{Utente} vuole rimuovere una traccia audio da una nota nel diario criptato
\end{itemize}
