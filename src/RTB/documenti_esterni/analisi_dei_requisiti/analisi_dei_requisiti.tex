...
\hline
\rowcolor{white}
1.3.0 & 2026-03-19 & Marco Sanguin & Aggiunta dei casi d'uso per il diario fittizio da \hyperref[sec:UC-37]{UC-37} a \hyperref[subsec:UC-43]{UC-43} & Riccardo Manisi \\
\hline
\rowcolor{gray!20}
...
% UC modifica e visualizzazione note diario fittizio
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Trigger:} L'attore ha scelto la voce di eliminazione per una nota nel diario fittizio
\end{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Trigger:} L'\term{Utente} vuole creare una nuova nota nel diario fittizio
\end{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Trigger:} L'\term{Utente} vuole aggiungere del testo ad una nota nel diario fittizio
\end{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Trigger:} L'\term{Utente} vuole aggiungere del contenuto multimediale ad una nota nel diario fittizio
\end{itemize}

\subsubsection{UC-41.1 - Inserimento immagine in nota diario fittizio} \label{subsec:UC-41.1}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Autenticato al diario
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Trigger:} L'\term{Utente} vuole aggiungere un'immagine ad una nota nel diario fittizio
\end{itemize}

\subsubsection{UC-41.2 - Inserimento audio in nota diario fittizio} \label{subsec:UC-41.2}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Autenticato al diario
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Trigger:} L'\term{Utente} vuole aggiungere del contenuto audio ad una nota nel diario fittizio
\end{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Trigger:} L'\term{Utente} vuole rimuovere del contenuto multimediale da una nota nel diario fittizio
\end{itemize}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Trigger:} L'\term{Utente} vuole rimuovere un'immagine da una nota nel diario fittizio
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item L'attore seleziona la voce apposita per la rimozione dell'immagine
    \end{itemize}
    \item \textbf{Trigger:} L'\term{Utente} vuole rimuovere una traccia audio da una nota nel diario fittizio
\end{itemize}
