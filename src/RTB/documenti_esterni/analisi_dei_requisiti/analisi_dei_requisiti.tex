...
\subsubsection{UC-61 - Visualizzazione lista leggi} \label{sec:UC-61}
\begin{figure}[H]
    \centering
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Il sistema visualizza le voci della lista delle leggi $\rightarrow$ \ref{subsec:UC-61.1}
        \item L'attore può scorrere la lista per cercare l'argomento di interesse
    \end{itemize}
    \item \textbf{Inclusioni:} 
    \begin{itemize}
        \item \hyperref[subsec:UC-61.1]{UC-61.1}
    \end{itemize}
    \item \textbf{Trigger:} L'attore vuole informarsi sui propri diritti legali
\end{itemize}

\subsubsection{UC-61.1 - Visualizzazione singola legge nella lista} \label{subsec:UC-61.1}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Generico
    \item \textbf{Pre-condizioni:} 
    \begin{itemize}
...
\subsubsection{UC-62 - Visualizzazione dettagli legge} \label{sec:UC-62}
\begin{figure}[H]
    \centering
...
\begin{itemize}
    ...
    \item \textbf{Scenario secondario:} 
    \begin{itemize}
         \item Errore nel caricamento dei dati $\rightarrow$ \ref{subsec:UC-5}
    \end{itemize}
    \item \textbf{Estensioni:}
    \begin{itemize}
     \item \hyperref[subsec:UC-5]{UC-5}
