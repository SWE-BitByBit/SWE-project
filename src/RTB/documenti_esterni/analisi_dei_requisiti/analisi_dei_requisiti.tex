...
\hline
\rowcolor{gray!20}
RF-DE-2 & Il sistema mostra all'utente una breve descrizione del funzionamento del Dead Man's Switch & \hyperref[subsec:UC-19]{UC-19}, \hyperref[subsec:UC-20]{UC-20} \\
\hline
\rowcolor{white}
...
\hline
\rowcolor{white}
RF-DE-13 & Il sistema deve mostrare all'utente una spiegazione del tipo di contesto a cui può passare (Detective delle relazioni) & \hyperref[subsec:UC-51]{UC-51} \\
\hline
\rowcolor{gray!20}
RF-DE-14 & Il sistema deve mostrare all'utente una spiegazione del tipo di contesto a cui può passare (Specchio intelligente) & \hyperref[subsec:UC-52]{UC-52} \\
\hline
\rowcolor{white}
...
\hline
\rowcolor{white}
RF-OP-4 & Il sistema deve indicare all'utente se le risorse sono autorevoli e verificate & \hyperref[subsec:UC-59]{UC-59} \\
\hline
\rowcolor{gray!20}
