...
\subsubsection{UC-19 - Impostazione password per diario criptato} \label{subsec:UC-19}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{use_case/UC-19-impostazione-password-diario-criptato.png}
    \caption{Diagramma del caso d'uso UC-19}
    \label{fig:UC-19}
\end{figure}
\begin{itemize}
    ...
    \begin{itemize}
        \item La password non è conforme ai criteri di sicurezza minimi imposti dal sistema. La password non viene memorizzata e viene mostrato un messaggio di errore. $\rightarrow$ \ref{subsec:UC-20}
    \end{itemize}
    \item \textbf{Estensioni:}
    \begin{itemize}
...
\subsubsection{UC-20 - Password non conforme ai criteri} \label{subsec:UC-20}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Generico
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
...
\subsubsection{UC-21 - Impostazione password per diario fittizio} \label{subsec:UC-21}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{use_case/UC-21-impostazione-password-diario-fittizio.png}
...
\begin{itemize}
    ...
    \item \textbf{Scenari secondari:} 
    \begin{itemize}
        \item La password del diario fittizio combacia con quella già impostata del diario criptato. $\rightarrow$ \ref{subsec:UC-22}
        \item La password non è conforme ai criteri di sicurezza minimi imposti dal sistema. La password non viene memorizzata e viene mostrato un messaggio di errore. $\rightarrow$ \ref{subsec:UC-20}
    \end{itemize}
    \item \textbf{Estensioni:}
    \begin{itemize}
...
\subsubsection{UC-22 - Password uguale alla password del diario criptato} \label{subsec:UC-22}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} autenticato al diario
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
...
\subsubsection{UC-23 - Inserimento password accesso diario} \label{subsec:UC-23}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{use_case/UC-23-inserimento-password-accesso-diario.png}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item L'attore ha inserito la password errata più volte di quanto consentito dal sistema. Il sistema nega l'accesso e disabilita l'inserimento della password per un periodo di tempo predefinito. $\rightarrow$ \ref{subsec:UC-24}
    \end{itemize}
    \item \textbf{Estensioni:}
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \hyperref[subsec:UC-23.2]{UC-23.2}
    \end{itemize}
...
\subsubsection{UC-24 - Password errata troppe volte} \label{subsec:UC-24}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} autenticato al diario
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
...
\subsubsection{UC-23.1 - Inserimento password accesso diario criptato} \label{subsec:UC-23.1}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} autenticato al diario
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
...
\subsubsection{UC-23.2 - Inserimento password accesso diario fittizio} \label{subsec:UC-23.2}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} autenticato al diario
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
...
\subsubsection{UC-26 - Visualizzazione diario criptato} \label{subsec:UC-26}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{use_case/UC-26-visualizzazione-diario-criptato.png}
    \caption{Diagramma del caso d'uso UC-26}
    \label{fig:UC-26}
\end{figure}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} autenticato al diario
    ...
    \begin{itemize}
        ...
        \item Il sistema carica e visualizza la lista delle note presenti $\rightarrow$ \ref{subsec:UC-27}
    \end{itemize}
    \item \textbf{Inclusioni:}
    \begin{itemize}
...
\subsubsection{UC-27 - Visualizzazione lista note nel diario criptato} \label{subsec:UC-27}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} autenticato al diario
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Il sistema visualizza, in una lista, le anteprime di ogni singola nota $\rightarrow$ \ref{subsec:UC-28}
    \end{itemize}
    \item \textbf{Inclusioni:}
    \begin{itemize}
        \item \hyperref[subsec:UC-28]{UC-28}
    \end{itemize}
    \item \textbf{Trigger:} L'attore accede al diario criptato
\end{itemize}

\subsubsection{UC-28 - Visualizzazione anteprima singola nota della lista nel diario criptato} \label{subsec:UC-28}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} autenticato al diario
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
...
\subsubsection{UC-33 - Visualizzazione diario fittizio} \label{subsec:UC-33}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{use_case/UC-33-visualizzazione-diario-fittizio.png}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Il sistema carica e visualizza la lista delle note presenti $\rightarrow$ \ref{subsec:UC-34}
    \end{itemize}
    \item \textbf{Inclusioni:}
    \begin{itemize}
        \item \hyperref[subsec:UC-34]{UC-34}
    \end{itemize}
    \item \textbf{Trigger:} L'attore accede al diario fittizio
\end{itemize}

\subsubsection{UC-34 - Visualizzazione lista note nel diario fittizio} \label{subsec:UC-34}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} autenticato al diario
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Il sistema organizza le anteprime delle note secondo un ordine prestabilito
        \item Il sistema visualizza, in una lista, le anteprime di ogni singola nota $\rightarrow$ \ref{subsec:UC-35}
    \end{itemize}
    \item \textbf{Inclusioni:}
    \begin{itemize}
        \item \hyperref[subsec:UC-35]{UC-35}
    \end{itemize}
    \item \textbf{Trigger:} L'attore accede al diario fittizio
\end{itemize}

\subsubsection{UC-35 - Visualizzazione anteprima singola nota della lista nel diario fittizio} \label{subsec:UC-35}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} autenticato al diario
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
