...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item L'attore può visualizzare una singola chat dalla lista $\rightarrow$ \ref{subsec:UC-57.1}
    \end{itemize}
    \item \textbf{Inclusioni:}
    \begin{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Il sistema mostra la preview del primo messaggio della chat nella lista $\rightarrow$ \ref{subsec:UC-57.1.1}
    \end{itemize}
    \item \textbf{Inclusioni:}
    \begin{itemize}
...
\subsubsection{UC-57.1.1 - Visualizzazione preview inizio chat della cronologia} \label{subsec:UC-57.1.1}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Generico
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
