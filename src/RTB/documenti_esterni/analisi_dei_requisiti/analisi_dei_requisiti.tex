...
\begin{itemize}
    ...
    \item \textbf{Scenario secondario:} 
    \begin{itemize}
        \item Errore nel caricamento del contenuto della chat $\rightarrow$ \hyperref[sec:UC-5]{UC-5}
    \end{itemize}
    \item \textbf{Inclusioni:} 
    \begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Scenario secondario:} 
    \begin{itemize}
         \item Errore nel caricamento dei dati $\rightarrow$ \hyperref[sec:UC-5]{UC-5}
    \end{itemize}
    \item \textbf{Estensioni:}
    \begin{itemize}
     \item \hyperref[sec:UC-5]{UC-5}
