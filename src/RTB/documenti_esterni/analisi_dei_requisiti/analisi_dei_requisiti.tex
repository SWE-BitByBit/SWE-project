...
\begin{itemize}
    ...
    \item \textbf{Post-condizioni:}
    \begin{itemize}
        \item L'attore conferma l'eliminazione della nota del diario criptato
        \item Il sistema elimina correttamente la nota del diario criptato
        \item La nota non è più visibile nella lista delle note del diario criptato
    \end{itemize}
    \item \textbf{Scenario principale:}
    \begin{itemize}
        \item Il sistema visualizza la rischiesta di conferma per l'eliminazione della nota del diario criptato
    \end{itemize}
    \item \textbf{Trigger:} L'attore desidera elimanare una nota del diario criptato
\end{itemize}
