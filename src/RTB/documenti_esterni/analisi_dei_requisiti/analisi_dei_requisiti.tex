...
>>>>>>> a0fd3d3ef48e372f21d0ad976cd1e17a0eb14272
\end{itemize}
...
RF-OB-4 & L'Utente deve poter selezionare il profilo di utilizzo ("Per me" o "Per altri") & \hyperref[subsec:UC-3]{UC-3} \\
\hline
...
RF-OB-104 & L'Utente deve poter interrompere la generazione della risposta dell'LLM durante la consultazione del chatbot & \hyperref[sec:UC-49]{UC-49} \\
\hline
...
RF-OB-109 & Il sistema deve notificare l'Utente di un errore durante il cambio di contesto del chatbot e mantenere il contesto precedente & \hyperref[sec:UC-53]{UC-53} \\
\hline

RF-OB-110 & L'Utente deve poter ritentare il cambio di contesto del chatbot dopo la notifica di errore & \hyperref[sec:UC-53]{UC-53} \\
\hline
...
=======
RF-DE-2 & Il sistema mostra all'\term{Utente} una breve descrizione del funzionamento del Dead Man's Switch & \hyperref[sec:UC-19]{UC-19}, \hyperref[sec:UC-20]{UC-20} \\
\hline
\rowcolor{white}
RF-DE-3 & Il sistema deve permettere all'\term{Utente} di inserire più contenuti multimediali con una singola azione nel diario criptato & \hyperref[subsec:UC-34]{UC-34} \\
>>>>>>> a0fd3d3ef48e372f21d0ad976cd1e17a0eb14272
=======
...
>>>>>>> c05b612fe1596e06323a1db32cd75049fec60d96
=======
RF-OB-2 & Il sistema deve attivare automaticamente la funzionalità di Dead Man's Switch a seguito del login dell'Utente & \hyperref[subsec:UC-1]{UC-1}, \hyperref[sec:UC-15]{UC-15} \\
\hline
\rowcolor{white}
RF-OB-3 & L'Utente deve poter visualizzare un messaggio di errore esplicativo nel caso in cui l'autenticazione tramite Google Auth fallisca, venga annullata o restituisca parametri non validi & \hyperref[subsec:UC-2]{UC-2} \\
>>>>>>> 82aed59f83797ed074abfc5191bc633cc265c97c
\hline
\rowcolor{gray!20}
...
=======
RF-DE-7 & Il sistema deve permettere all'\term{Utente} di inserire più immagini con una singola azione nel diario fittizio & \hyperref[subsec:UC-41.1]{UC-41.1} \\
>>>>>>> a0fd3d3ef48e372f21d0ad976cd1e17a0eb14272
=======
...
=======
RF-DE-9 & Il sistema deve permettere all'\term{Utente} di riprodurre le tracce audio inserite nel diario criptato & \hyperref[subsec:UC-32.2.1]{UC-32.2.1} \\
>>>>>>> a0fd3d3ef48e372f21d0ad976cd1e17a0eb14272
=======
=======
RF-OB-7 & L'Utente deve poter ricaricare la sezione dei contatti fidati dopo la visualizzazione dell'errore di caricamento dei dati dal database & \hyperref[sec:UC-4]{UC-4}, \hyperref[sec:UC-5]{UC-5} \\
\hline
\rowcolor{gray!20}
>>>>>>> e623141a248ec8ee24b8de509b04b70948f62f93
...
\hline
\rowcolor{gray!20}
RF-OB-32 & L'Utente deve poter impostare il timer di prima inattività (per la funzionalità di Dead Man's Switch) & \hyperref[sec:UC-15]{UC-15} \\
\hline
\rowcolor{white}
RF-OB-33 & L'Utente deve poter impostare il timer di seconda inattività (per la funzionalità di Dead Man's Switch) & \hyperref[sec:UC-16]{UC-16} \\
\hline
\rowcolor{gray!20}
RF-OB-34 & L'Utente deve poter modificare le informazioni della mail di avviso & \hyperref[sec:UC-17]{UC-17} \\
\hline
...
=======
RF-OB-138 & L'Utente deve poter comporre automaticamente il numero di un contatto d'emergenza tramite l'apposita voce & \hyperref[sec:UC-63]{UC-63} \\
\hline
\rowcolor{white}
RF-OB-139 & L'Utente deve poter visualizzare la lista del materiale informativo disponibile & \hyperref[sec:UC-64]{UC-64} \\
\hline
...
=======
=======
>>>>>>> ec326858e9c9d61c9c825dc9b38633abd2d994f0
RF-OB-142 & L'Utente deve poter visualizzare il contenuto di un materiale informativo selezionato dalla lista & \hyperref[sec:UC-65]{UC-65} \\
\hline
\rowcolor{white}
RF-OB-143 & Il sistema deve notificare l'Utente di un errore nel recupero dei dati del materiale informativo & \hyperref[sec:UC-5]{UC-5}, \hyperref[sec:UC-65]{UC-65} \\
...
\hline
\rowcolor{white}
RV-OB-5 & L'Architettura del Backend deve basarsi su un modello a microservizi di tipo Serverless, avvalendosi dell'esecuzione di funzioni AWS Lambda & \href{https://www.math.unipd.it/~tullio/IS-1/2025/Progetto/C4.pdf}{Capitolato} \newline Sez. 3.2 \\
\hline
\rowcolor{gray!20}
