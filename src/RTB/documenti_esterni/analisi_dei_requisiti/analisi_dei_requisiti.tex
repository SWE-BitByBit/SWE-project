...
\subsubsection{UC-65 - Visualizzazione lista materiale informativo} \label{sec:UC-65}
\begin{figure}[H]
    \centering
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item L'attore può visualizzare singolarmente ogni materiale nella lista $\rightarrow$ \ref{subsec:UC-65.1}
        \item L'attore può scorrere la lista per trovare il contenuto di interesse
    \end{itemize}
    \item \textbf{Inclusioni:}
     \begin{itemize}
         \item \hyperref[subsec:UC-65.1]{UC-65.1}
     \end{itemize}
    \item \textbf{Trigger:} L'attore vuole consultare risorse educative o di supporto
\end{itemize}

\subsubsection{UC-65.1 - Visualizzazione singolo materiale informativo} \label{subsec:UC-65.1}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Generico
    \item \textbf{Pre-condizioni:} 
    \begin{itemize}
...
\subsubsection{UC-66 - Visualizzazione dettagli materiale informativo} \label{sec:UC-66}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{use_case/UC-66-coraggio.png}
    \caption{Diagramma del caso d'uso UC-66}
    \label{fig:UC-66}
\end{figure}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Generico
    ...
    \item \textbf{Scenario secondario:} 
    \begin{itemize}
         \item Si \term{Verifica} un errore durante il recupero dei dati $\rightarrow$ \ref{subsec:UC-5}
    \end{itemize}
    \item \textbf{Estensioni:}
     \begin{itemize}
         \item \hyperref[subsec:UC-5]{UC-5}
...
\subsubsection{UC-67 - Visualizzazione mappa luoghi sicuri} \label{sec:UC-67}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{use_case/UC-67-coraggio.png}
    \caption{Diagramma del caso d'uso UC-67}
    \label{fig:UC-67}
\end{figure}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Generico
...
\subsubsection{UC-68 - Apertura luogo in Google Maps} \label{subsec:UC-68}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Generico
    ...
    \item \textbf{Scenario secondario:} 
    \begin{itemize}
         \item Si \term{Verifica} un errore nell'apertura dell'applicazione esterna $\rightarrow$ \ref{subsec:UC-69}
    \end{itemize}
    \item \textbf{Estensioni:}
     \begin{itemize}
         \item \hyperref[subsec:UC-69]{UC-69}
     \end{itemize}
    \item \textbf{Trigger:} L'attore vuole avviare la navigazione o vedere dettagli aggiuntivi del luogo
\end{itemize}

\subsubsection{UC-69 - Errore apertura luogo in mappa esterna} \label{subsec:UC-69}
\begin{itemize}
    \item \textbf{Attore principale:} \term{Utente} Generico
    \item \textbf{Pre-condizioni:}
    \begin{itemize}
