...
\begin{tcolorbox}[colback=gray!10,colframe=gray!50,title=Nota]
{\small Il caso d'uso \hyperref[subsec:UC-56]{UC-56} include il caso d'uso \hyperref[subsec:UC-56.1]{UC-56.1} e viene esteso da \hyperref[subsec:UC-56.2]{UC-56.2}.
Il diagramma riportato di seguito mostra anche ulteriori casi d'uso correlati (\hyperref[subsec:UC-56.1.1]{UC-56.1.1} e \hyperref[subsec:UC-56.1.2]{UC-56.1.2}), la cui descrizione dettagliata è riportata nelle sezioni successive del documento.}
\end{tcolorbox}
\begin{figure}[H]
    \centering
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Il sistema visualizza la lista dei messaggi scambiati tra attore e chatbot $\rightarrow$ \ref{subsec:UC-56.1}
    \end{itemize}
    \item \textbf{Scenario secondario:} 
    \begin{itemize}
        \item Errore nel caricamento del contenuto della chat $\rightarrow$ \ref{subsec:UC-5}
    \end{itemize}
    \item \textbf{Inclusioni:} 
    \begin{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Il sistema visualizza i messaggi dell'\term{Utente} $\rightarrow$ \ref{subsec:UC-56.1.1}
        \item Il sistema visualizza i messaggi del chatbot $\rightarrow$ \ref{subsec:UC-56.1.2}
