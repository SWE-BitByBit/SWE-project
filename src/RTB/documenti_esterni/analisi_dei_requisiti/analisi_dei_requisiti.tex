...
\hline
\rowcolor{gray!20}
RF-OB-32 & L'\term{Utente} deve poter effettuare il logout dopo essersi autenticato all'applicazione & \hyperref[sec:UC-14]{UC-14} \\
\hline
\rowcolor{gray!20}
...
\hline
\rowcolor{gray!20}
RF-DE-2 & Il sistema mostra all'\term{Utente} una breve descrizione del funzionamento del Dead Man's Switch & \hyperref[subsec:UC-19]{UC-19}, \hyperref[subsec:UC-20]{UC-20} \\
\hline
\rowcolor{white}
...
\hline
\rowcolor{gray!20}
RF-DE-12 & Il sistema deve utilizzare i contenuti del diario criptato per personalizzare le risposte del chatbot & \hyperref[subsec:UC-48]{UC-48} \\
\hline
\rowcolor{white}
RF-DE-13 & Il sistema deve mostrare all'\term{Utente} una spiegazione del tipo di contesto a cui può passare (Detective delle relazioni) & \hyperref[subsec:UC-51]{UC-51} \\
\hline
\rowcolor{gray!20}
RF-DE-14 & Il sistema deve mostrare all'\term{Utente} una spiegazione del tipo di contesto a cui può passare (Specchio intelligente) & \hyperref[subsec:UC-52]{UC-52} \\
\hline
\rowcolor{white}
...
\caption{Tabella Requisiti Funzionali obbligatori} \label{tab:requisiti_funzionali_desiderabili} \\
\end{longtable}
\end{center}
...
\hline
\rowcolor{white}
RF-OP-4 & Il sistema deve indicare all'\term{Utente} se le risorse sono autorevoli e verificate & \hyperref[subsec:UC-59]{UC-59} \\
\hline
\rowcolor{gray!20}
RF-OP-5 & Il sistema deve mettere a disposizione leggi estere & \hyperref[sec:UC-60]{UC-60} \\
\hline
\rowcolor{white}
RF-OP-6 & Il sistema deve mostrare leggi aggiornate, giuridicamente valide e complete & \hyperref[subsec:UC-61]{UC-61} \\
\hline
\rowcolor{gray!20}
...
\caption{Tabella Requisiti Funzionali obbligatori} \label{tab:requisiti_funzionali_opzionali} \\
\end{longtable}
\end{center}
