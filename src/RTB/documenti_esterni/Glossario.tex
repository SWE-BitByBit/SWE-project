...
\section{Acronimi}
\begin{itemize}
    \item \begin{tabular}{p{0.22\linewidth} p{0.72\linewidth}}
...
\subsection{Branch}
Area contenuta di un repository in cui possono essere effettuate modifiche senza che abbiano effetto sul resto del progetto.
...
\subsection{Merge}
Procedura in cui le modifiche su un branch vengono combinate con un altro branch.
