...
\newcommand{\VersioneAttuale}{1.1.2}
...
\begin{itemize}
    ...
    \item \textbf{RO1 (Errata stima dei tempi)}: 
\end{itemize}
...
Per prevenire disallineamenti significativi tra quanto progettato e i successivi riscontri ricevuti, ...
