...
\endhead
\rowcolor{white}
1.1.5 & 2026-05-05 & Ferdinando Fracasso & Scrutti sezione Sprint 12 & Gabriele Scaggiante \\
\hline
\rowcolor{gray!20}
...
\paragraph{Informazioni generali e attività da svolgere}
Lo \term{Sprint} 12 si focalizza sul completamento della parte di Backend del progetto e sull'integrazione con il Frontend delle funzionalità implementate. In seguito al completamento della parte di codice si andrà ad aggiornare il documento di Specifica Tecnica con informazioni più recenti ed in linea con lo sviluppo. Infine si valuteranno i requisiti funzionali insieme all'azienda proponente, eventualmente riclassificandoli se necessario in vista della consegna del MVP.\\ 
Le attività pianificate includono:
\begin{itemize}
    ...
    \item \textbf{Programmazione:} Completare parti mancanti del Backend, effettuare deploy della funzionalità chatbot e integrare Frontend e Backend delle funzionalità completate.
