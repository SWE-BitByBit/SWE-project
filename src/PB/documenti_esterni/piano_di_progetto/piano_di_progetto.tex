...
\newcommand{\VersioneAttuale}{1.1.4}
...
Di seguito sono elencate le principali attività pianificate per il periodo della \term{Product Baseline}:
...
\begin{itemize}
    ...
    \item \textbf{RT2 (Problemi strumenti software):} Errori nella configurazione iniziale di SAM, che hanno causato problemi sia nella fase di \term{Deploy} che nell'avvio dei test automatizzati.
\end{itemize}
