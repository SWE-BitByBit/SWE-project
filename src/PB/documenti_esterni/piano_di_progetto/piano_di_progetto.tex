...
\paragraph{Informazioni generali e attività da svolgere}
Lo \term{Sprint} 10 è orientato, ancora, al completamento del documento di \term{Specifica Tecnica}. In continuità con i progressi conseguiti nello \term{Sprint} 9, lo \term{Sprint} 10 si propone inoltre di avviare lo sviluppo lato backend di alcune funzionalità dell’applicazione. Le attività pianificate includono:
...
\item \textbf{Programmazione:} Conclusione dello sviluppo frontend delle principali funzionalità applicative la cui progettazione era già stata ultimata nello \term{Sprint} 9. Inizio dello sviluppo backend, con particolare attenzione alla realizzazione dei servizi \term{Serverless} e alla loro integrazione con i servizi di storage e database. Si fa riferimento, in particolare, alla gestione del diario, alla realizzazione della homepage e dei contatti fidati, e all’implementazione delle componenti legate al chatbot. 
\end{itemize}
