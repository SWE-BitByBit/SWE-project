...
\begin{itemize}
    ...
    \item \textbf{RT2 (Inesperienza tecnologica):} Errori nella configurazione iniziale di SAM, che hanno causato problemi sia nella fase di Deploy che nell'avvio dei test automatizzati.
\end{itemize}
