...
\begin{table}[H] %da aggiornare
    ...
    \begin{tabularx}{\textwidth}{|l|c|c|c|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|}
        ...
        \hline
        \rowcolor{tableLineOdd}
        Responsabile & 30\euro/h & 9 & 150\euro & 18 \textcolor{red}{(-9)} & 540\euro \textcolor{red}{(-270\euro)} \\
        \hline
        \rowcolor{tableLineEven}
        Amministratore & 20\euro/h & 6 & 130\euro & 16.25 \textcolor{red}{(-6)} & 325\euro \textcolor{red}{(-120\euro)} \\
        \hline
        \rowcolor{tableLineOdd}
        Analista & 25\euro/h & - & - & 0.5  & 12,50\euro \\
        \hline
        \rowcolor{tableLineEven}
        Progettista & 25\euro/h & 43 & - & 28 \textcolor{red}{(-43)} & 700 \textcolor{red}{(-1.075\euro)} \\
        \hline
        \rowcolor{tableLineOdd}
        Programmatore & 15\euro/h & 13 & 360\euro & 73 \textcolor{red}{(-13)} & 1.095\euro \textcolor{red}{(-195\euro)} \\
        \hline
        \rowcolor{tableLineEven}
        Verificatore & 15\euro/h & 9 & 75\euro & 47.5 \textcolor{red}{(-9)} & 712,50\euro \textcolor{red}{(-75\euro)} \\
        \hline
        \rowcolor{tableHeader}
