...
\endhead
\rowcolor{gray!20}
1.1.4 & 2026-04-28 & Dennis Parolin & Scritta sezione \term{Sprint} 11 & Ferdinando Fracasso \\
\hline
\rowcolor{white}
...
\begin{itemize}
    ...
    \item \textbf{RT2 (Inesperienza tecnologica):} Errori nella configurazione iniziale di SAM, che hanno causato problemi sia nella fase di \term{Deploy} che nell'avvio dei test automatizzati.
\end{itemize}
