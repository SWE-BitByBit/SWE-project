...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=1.2]
        % Responsabile (6.6%)
        \draw[thick,fill=pieResp] (0,0) -- (0:1.5) arc (0:24:1.5) -- cycle;
        \draw (12:2) node {6.6\%};
        
        % Amministratore (6.6%)
        \draw[thick,fill=pieAmm] (0,0) -- (24:1.5) arc (24:48:1.5) -- cycle;
        \draw (36:1.95) node {6.6\%};

        % Programmatore (52.7%)
        \draw[thick,fill=pieProg] (0,0) -- (48:1.5) arc (48:238:1.5) -- cycle;
        \draw (143:2.1) node {52.7\%};

        % Verificatore (34.1%)
        \draw[thick,fill=pieVer] (0,0) -- (238:1.5) arc (238:360:1.5) -- cycle;
        \draw (299:1.9) node {34.1\%};
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|l|C|C|C|C|C|C|}
        ...
        \hline
        \rowcolor{tableLineOdd}
        F. Fracasso & 3 & - & - & - & 2 & 0.5 \textcolor{red}{(-0.5)} \\
        \hline
        \rowcolor{tableLineEven}
        R. Manisi & - & - & - & - & 8 \textcolor{red}{(+3)} & 3 \textcolor{red}{(-1.5)} \\
        \hline
        \rowcolor{tableLineOdd}
        D. Parolin & - & - & - & 0.75 \textcolor{red}{(+0.75)} & 3 \textcolor{red}{(+1)} & 2 \\
        \hline
        \rowcolor{tableLineEven}
        M. Sanguin & - & - & - & - & 4 & 3 \\
        \hline
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=1.2]
        % Responsabile (6.2%)
        \draw[thick,fill=pieResp] (0,0) -- (0:1.5) arc (0:22:1.5) -- cycle;
        \draw (11:2) node {6.2\%};
        
        % Amministratore (6.2%)
        \draw[thick,fill=pieAmm] (0,0) -- (22:1.5) arc (22:44:1.5) -- cycle;
        \draw (33:1.9) node {6.2\%};
        
        % Progettista (1.6%)
        \draw[thick,fill=pieDes] (0,0) -- (44:1.5) arc (44:50:1.5) -- cycle;
        \draw (47:1.95) node {1.6\%};

        % Programmatore (58.0%)
        \draw[thick,fill=pieProg] (0,0) -- (50:1.5) arc (50:259:1.5) -- cycle;
        \draw (155.5:2) node {58\%};

        % Verificatore (28.0%)
        \draw[thick,fill=pieVer] (0,0) -- (259:1.5) arc (259:360:1.5) -- cycle;
        \draw (309.5:1.9) node {28\%};
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|l|c|c|c|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|}
        ...
        \hline
        \rowcolor{tableLineOdd}
        Programmatore & 15\euro/h & 28 & 420\euro & -30.75 \textcolor{red}{(-28)} & -461.25\euro \textcolor{red}{(-585\euro)} \\
        \hline
        \rowcolor{tableLineEven}
        Verificatore & 15\euro/h & 13.5 & 180\euro & 10.75 \textcolor{red}{(-13.5)} & 131.25\euro \textcolor{red}{(-180\euro)} \\
        \hline
        \rowcolor{tableHeader}
        \textbf{Totale} & - & \textbf{48.25} & \textbf{791,25\euro} & \textbf{-7.25 \textcolor{red}{(-48.25)}} & \textbf{2,50\euro \textcolor{red}{(-791,25\euro)}} \\
        \hline
    \end{tabularx}
