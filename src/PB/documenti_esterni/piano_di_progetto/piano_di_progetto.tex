...
\paragraph{Informazioni generali e attività da svolgere}
Lo \term{Sprint} 8 segna l'inizio dei lavori per la Product \term{Baseline} (\term{PB}), spostando il focus sull'impostazione architetturale dell'\term{MVP}, la ripianificazione a lungo termine e l'aggiornamento della documentazione a seguito dei feedback ricevuti dai docenti (Prof. Vardanega e Prof. Cardin) in seguito alla revisione RTB.
Le attività pianificate e svolte includono:
\begin{itemize}
