...
\endhead
\rowcolor{white}
1.1.5 & 2026-05-05 & Ferdinando Fracasso & Scrutti sezione \term{Sprint} 12 & Gabriele Scaggiante \\
\hline
\rowcolor{gray!20}
...
\begin{itemize}
    ...
    \item \textbf{Programmazione:} Completare parti mancanti del \term{Backend}, effettuare deploy della funzionalità chatbot e integrare Frontend e \term{Backend} delle funzionalità completate.
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|l|c|c|c|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}X|}
        ...
        \hline
        \rowcolor{tableLineOdd}
        Responsabile & 30\euro/h & 3 & 90\euro & 4 \textcolor{red}{(-3)} & 120\euro \textcolor{red}{(-60\euro)} \\
        \hline
        \rowcolor{tableLineEven}
        ...
        \hline
        \rowcolor{tableLineEven}
        Progettista & 25\euro/h & 0.75 & 18,75\euro & 2 \textcolor{red}{(-0.75)} & 50\euro \textcolor{red}{(-187,50\euro)} \\
        \hline
        \rowcolor{tableLineOdd}
        Programmatore & 15\euro/h & 23 & 345\euro & -25.75 \textcolor{red}{(-23)} & -386.25\euro \textcolor{red}{(-585\euro)} \\
        \hline
        \rowcolor{tableLineEven}
        Verificatore & 15\euro/h & 10 & 180\euro & 14.25 \textcolor{red}{(-10)} & 213.75\euro \textcolor{red}{(-180\euro)} \\
        \hline
        \rowcolor{tableHeader}
