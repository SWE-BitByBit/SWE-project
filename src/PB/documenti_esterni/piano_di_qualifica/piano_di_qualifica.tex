...
TB-66-U & [DiaryAuthService] Verificare che il metodo \texttt{set\_real\_password} imposti correttamente la password per il diario reale tramite il \term{Repository}. & I \\
\hline
TB-67-U & [DiaryAuthService] Verificare che il metodo \texttt{set\_fake\_password} imposti correttamente la password per il diario fittizio tramite il \term{Repository}. & I \\
\hline
