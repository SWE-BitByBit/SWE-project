...
\begin{longtable}{|l|p{10cm}|c|}
    ...
    \hline
    TB-6-I & \term{Verifica} dell'integrazione tra il componente TrustedContactRepository e il servizio Amazon DynamoDB per la gestione dei contatti di emergenza. & I \\
    \hline
