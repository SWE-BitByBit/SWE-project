...
\begin{longtable}{|l|p{10cm}|c|}
    ...
    \hline
    TB-14-I & \term{Verifica} dell'integrazione tra il componente DynamoAuthAdapter e il servizio Amazon DynamoDB per la persistenza delle credenziali di accesso (reali e fake) al diario. & I \\
    \hline
