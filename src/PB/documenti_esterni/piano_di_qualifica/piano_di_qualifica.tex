...
\end{tabularx}
\caption{Soglie delle metriche per il \protectProcesso di fornitura}
\end{table}
...
\end{tabularx}
\caption{Soglie delle metriche per il \protectProcesso di documentazione}
\end{table}
...
\hline
\rowcolor{white}
\caption[]{Tabella dei \protectTest di Sistema} \\
\endfoot
\hline
\caption{Tabella dei \protectTest di Sistema} \\
\endlastfoot
...
\hline
\endfirsthead
\caption[]{Tracciamento dei \protectTest di Sistema} \\
\hline
\rowcolor{gray!60}
\textbf{Codice Test} & \textbf{Codice Requisito} \\
\hline
...
\hline
\rowcolor{white}
\caption{Tracciamento dei \protectTest di Sistema} \label{tab:tracciamento_test_sistema} \\
\end{longtable}
\endgroup
...
\hline
\rowcolor{white}
\caption[]{Tabella dei \protectTest di Accettazione} \\
\endfoot
\hline
\rowcolor{white}
\caption{Tabella dei \protectTest di Accettazione} \\
...
\hline
\rowcolor{white}
\caption[]{Tabella dei \protectTest di Unità - Frontend} \\
\endfoot
\hline
\caption{Tabella dei \protectTest di Unità - Frontend} \\
\endlastfoot
...
\hline
\rowcolor{white}
\caption[]{Tabella dei \protectTest di Unità - \protectBackend} \\
\endfoot
\hline
\caption{Tabella dei \protectTest di Unità - \protectBackend} \\
\endlastfoot
...
\begin{longtable}{|l|p{10cm}|c|}
    ...
    \hline
    \caption{Tracciamento dei \protectTest di Integrazione \protectBackend per materiali informativi e luoghi sicuri}
    \endlastfoot
