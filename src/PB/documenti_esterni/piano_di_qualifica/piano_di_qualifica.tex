...
\subsection{MPD01, MPD02, MPD03: Soddisfazione requisiti}

%Metriche Sonarqube
\subsection{MPD04: Reliability Rating, MPD06: Maintanability Rating}
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{pdq/MPD04-MPD05_frontend.png}
    \caption{Rating di Reliability e Maintainability del codice frontend}
    \label{fig:Rating MPD04 e MPD05 codice frontend}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{pdq/MPD04-MPD05_backend.png}
    \caption{Rating di Reliability e Maintainability del codice backend}
    \label{fig:Rating MPD04 e MPD05 codice backend}
\end{figure}

\subsection{MPD08: Code Coverage}
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{pdq/MPD08_frontend.png}
    \caption{Rating di Code Coverage del codice frontend}
    \label{fig:Rating MPD08 codice frontend}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{pdq/MPD08_backend.png}
    \caption{Rating di Code Coverage del codice backend}
    \label{fig:Rating MPD08 codice backend}
\end{figure}

\subsection{MPD09: Unit Test Success Density}
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{pdq/MPD09.png}
    \caption{Unit Test Success Density}
    \label{fig:MPD09 Unit Test Success Density}
\end{figure}
Dato l'utilizzo della versione gratuita di SonarQube, non è stato possibile ottenere un grafico dello storico della metrica. 
