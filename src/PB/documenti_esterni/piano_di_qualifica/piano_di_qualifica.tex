...
\subsection{Test di Integrazione - Frontend}\label{sec:test_integrazione_frontend}
...
\begin{longtable}{|c|p{10cm}|c|}
    ...
    \hline
    TF-2-I & \term{Verifica} dell'integrazione end-to-end: corretto caricamento e rendering della mappa interattiva (\texttt{SafePlaceMapWidget}). & I \\
    \hline
    TF-3-I & \term{Verifica} dell'integrazione end-to-end: apertura e visualizzazione della legenda informativa della mappa. & I \\
    \hline
    TF-4-I & \term{Verifica} dell'integrazione end-to-end: interazione con il pulsante di geolocalizzazione e comunicazione con il \texttt{LocationService}. & I \\
    \hline
    TF-5-I & \term{Verifica} dell'integrazione end-to-end: rendering dei marker sulla mappa recuperati tramite il SafePlaceService. & I \\
    \hline
    ...
    \hline
    TF-7-I & \term{Verifica} dell'integrazione end-to-end: rendering della lista dei materiali informativi ottenuta tramite il MaterialService. & I \\
    \hline
    TF-8-I & \term{Verifica} dell'integrazione end-to-end: funzionamento dei filtri per categoria (chip) e conseguente aggiornamento reattivo della vista. & I \\
    \hline
    TF-9-I & \term{Verifica} dell'integrazione end-to-end: ripristino della lista completa deselezionando i filtri (selezione del chip "Tutti"). & I \\
    \hline
    ...
    \hline
    TF-16-I & \term{Verifica} dell'integrazione end-to-end: inserimento della password e sblocco tramite \texttt{DiaryAccountService}. & I \\
    \hline
    TF-17-I & \term{Verifica} dell'integrazione end-to-end: caricamento e visualizzazione della lista delle note tramite \texttt{NoteService}. & I \\
    \hline
    ...
    \hline
    TF-19-I & \term{Verifica} dell'integrazione end-to-end: caricamento e visualizzazione della lista dei contatti tramite \texttt{TrustedContactService}. & I \\
    \hline
...
\begin{longtable}{|l|p{10cm}|c|}
    ...
    TB-1-I & \term{Verifica} dell'integrazione tra il componente \textt{S3ResourcesRepository} e il servizio Amazon S3 per il recupero e la mappatura dei materiali informativi. & I \\
    \hline
    TB-2-I & \term{Verifica} dell'integrazione tra l'entry point Lambda dei materiali informativi e la catena di componenti interni (Controller, Service, \term{Repository}). & I \\
    \hline
    TB-3-I & \term{Verifica} dell'integrazione tra il componente \textt{S3SafePlacesRepository} e il servizio Amazon S3 per il recupero dei marker relativi ai luoghi sicuri. & I \\
    \hline
    TB-4-I & \term{Verifica} dell'integrazione tra l'entry point Lambda dei luoghi sicuri e la catena di componenti interni (Controller, Service, \term{Repository}). & I \\
    \hline
    TB-5-I & \term{Verifica} dell'integrazione tra il componente \textt{DmsRepository} e il servizio Amazon DynamoDB per la persistenza e gestione delle configurazioni Dead Man's Switch. & I \\
    \hline
    TB-6-I & \term{Verifica} dell'integrazione tra il componente \textt{TrustedContactRepository} e il servizio Amazon DynamoDB per la gestione dei contatti di emergenza. & I \\
    \hline
    TB-7-I & \term{Verifica} dell'integrazione tra il componente \textt{NotificationRepository} e il servizio Amazon SES per l'invio delle email di notifica e di allerta. & I \\
    \hline
    ...
    \hline
    TB-10-I & \term{Verifica} dell'integrazione dell'entry point Lambda del chatbot con l'intera catena di componenti interni (Controller, Service, \term{Repository}) e il mock del servizio LLM. & I \\
    \hline
    TB-11-I & \term{Verifica} dell'integrazione dell'intero flusso Lambda per l'attivazione manuale dell'allarme SOS e il corretto innesco del \textt{NotificationRepository} verso Amazon SES. & I \\
    \hline
    ...
    \hline
    TB-14-I & \term{Verifica} dell'integrazione tra il componente \textt{DynamoAuthAdapter} e il servizio Amazon DynamoDB per la persistenza delle credenziali di accesso (reali e fake) al diario. & I \\
    \hline
    TB-15-I & \term{Verifica} dell'integrazione tra l'entry point Lambda dell'autenticazione diario e l'intera catena di componenti interni (Controller, Service, \term{Repository}). & I \\
    \hline
    TB-16-I & \term{Verifica} dell'integrazione tra il componente \textt{DynamoNoteAdapter} e il servizio Amazon DynamoDB per la persistenza delle note e dei relativi elementi multimediali. & I \\
    \hline
    TB-17-I & \term{Verifica} dell'integrazione tra il componente \textt{S3NoteAdapter} e il servizio Amazon S3 per la gestione del caricamento e dell'eliminazione degli allegati alle note. & I \\
    \hline
