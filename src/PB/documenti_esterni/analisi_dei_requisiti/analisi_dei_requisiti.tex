...
L'esperienza \ignoreglossary{utente} avrà inizio con una schermata di benvenuto volta a comprendere la finalità dell'installazione. Questa presenterà rapidamente le funzionalità chiave dell'app. 
...
\hline
\rowcolor{white}
RF-OP-8 & L'\term{Utente} deve poter visualizzare la lista dei contatti fidati & \hyperref[sec:UC-4]{UC-4} \\
\hline
