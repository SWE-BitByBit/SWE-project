...
\hline
\rowcolor{white}
RV-OB-5 & L'\term{Architettura} del \term{Backend} deve basarsi su un modello a microservizi, avvalendosi dell'esecuzione di funzioni AWS Lambda & \href{https://www.math.unipd.it/~tullio/IS-1/2025/Progetto/C4.pdf}{Capitolato} \newline Sez. 3.2 \\
\hline
\rowcolor{gray!20}
