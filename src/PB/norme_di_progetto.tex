...
\hline
\rowcolor{white}
0.11.4 & 2026-02-06 & Dennis Parolin & Modificata la sezione "Stesura dei requisiti" modificando la nomenclatura degli identificatori dei requisiti. Risolti problemi di compilazione. & Giovanni Visentin \\
\hline
\rowcolor{gray!20}
...
\begin{itemize}
    ...
    \item \textbf{draw.io}: strumento open source usato dal gruppo per la creazione di diagrammi UML delle classi, utilizzabile sia in ambiente web che desktop. Integra funzionalità di intelligenza artificiale che consentono la generazione automatica di diagrammi a partire da descrizioni testuali, velocizzando la produzione della documentazione grafica.
\end{itemize}
...
\subparagraph{Convenzioni di nomenclatura}
...
\subparagraph{Convenzioni nomenclatura delle classi}
...
\subparagraph{Formattazione automatica del codice} 
...
\subparagraph{Convenzioni sulla struttura gerarchia delle directory frontend} \label{subpar:convenzioni-gerarchia-dir-fe}
...
\subsubsection{\ignoreglossary{Verifica} della Documentazione}
...
\paragraph{Strumenti per la \ignoreglossary{Verifica} della documentazione}
...
\subsubsection{\ignoreglossary{Verifica} del Codice Software}
