...
\begin{itemize}
    ...
    \item \textbf{Ora inizio:} %modifica
    \item \textbf{Ora fine:} %modifica
    \item \textbf{Tipo riunione:}%modifica
    \item \textbf{Luogo:} %modifica
    \item \textbf{Durata:} %modifica
    \item \textbf{Responsabile:} %modifica
\end{itemize}
